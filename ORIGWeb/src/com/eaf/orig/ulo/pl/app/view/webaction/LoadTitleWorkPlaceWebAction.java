...
public class LoadTitleWorkPlaceWebAction extends WebActionHelper implements WebAction  {
	Logger logger = Logger.getLogger(LoadTitleWorkPlaceWebAction.class);
	...
	public boolean preModelRequest() {
        ...
        try {
			...
			valueListM.setSearchAction("LoadTitleWorkPlace");
