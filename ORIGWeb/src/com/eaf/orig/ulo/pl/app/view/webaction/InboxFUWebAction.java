...
public class InboxFUWebAction extends WebActionHelper implements WebAction,SearchMInf{
	
	static Logger logger = Logger.getLogger(InboxFUWebAction.class);	
	...
	public boolean preModelRequest(){		
		try{	
			...
			searchM.setReturnToAction("page=FU_PL_INBOX_SCREEN");			
	...
	private String getToDoListID(){
		...
		if(OrigUtil.isEmptyString(tdID)){
			 ...
			 if(currentMenuM != null){
				 ...
				 tdID = WorkflowConstant.TODO_LIST_ID.FU_INBOX;
			 }
		}		
		return tdID;
	}
