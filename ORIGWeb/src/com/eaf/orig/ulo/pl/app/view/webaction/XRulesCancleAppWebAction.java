...
public class XRulesCancleAppWebAction extends WebActionHelper implements WebAction{	
	static Logger logger = Logger.getLogger(XRulesCancleAppWebAction.class);	
	...
	public boolean preModelRequest(){		
		...
		PLApplicationDataM applicationM = PLOrigFormHandler.getPLApplicationDataM(getRequest());	
			...
			applicationM.setAppDecision(OrigConstant.Action.CANCEL);	
