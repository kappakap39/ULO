...
public class LoadTitleThaiNewWebAction extends WebActionHelper implements WebAction {
	
	Logger logger = Logger.getLogger(LoadTitleThaiNewWebAction.class);
	...
	public boolean preModelRequest(){
        ...
        try{
			...
			valueListM.setSearchAction("LoadTitleThaiNew");
