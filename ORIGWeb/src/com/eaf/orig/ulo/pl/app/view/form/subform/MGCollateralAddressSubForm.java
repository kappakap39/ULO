 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MGCollateralAddressSubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(MGCollateralAddressSubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("MGCollateralAddressSubForm");
