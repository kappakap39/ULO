...
public class LoadUnLockApplicationWebAction  extends WebActionHelper implements WebAction {
	
	static Logger logger = Logger.getLogger(LoadUnLockApplicationWebAction.class);
