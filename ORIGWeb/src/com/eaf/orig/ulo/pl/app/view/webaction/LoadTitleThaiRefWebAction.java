...
public class LoadTitleThaiRefWebAction extends WebActionHelper implements WebAction {
	Logger logger = Logger.getLogger(LoadTitleThaiRefWebAction.class);
	...
	public boolean preModelRequest() {
	 	String title_Thai = getRequest().getParameter("r_titleThai");
	 	logger.debug("r_titleThai= "+title_Thai);
...
//			valueListM.setTextboxDesc(title_Thai);
			...
			valueListM.setSearchAction("LoadTitleThaiRef");
