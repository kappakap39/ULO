...
public class EntityFormHandler extends FormHandler implements Serializable,Cloneable{
	private static transient Logger logger = Logger.getLogger(EntityFormHandler.class);	
	public EntityFormHandler(){
		super();
	...
	public String formName = "EntityForm";
