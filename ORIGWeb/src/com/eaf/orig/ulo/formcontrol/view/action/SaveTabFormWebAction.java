...
public class SaveTabFormWebAction extends WebActionHelper implements WebAction {
	private static transient Logger logger = Logger.getLogger(SaveTabFormWebAction.class);
	@Override
	...
	public boolean preModelRequest(){
		ResponseDataController controller = new ResponseDataController(getRequest(),ResponseData.FunctionId.SAVE_TAB);	
		String responseData = "";
		try{
