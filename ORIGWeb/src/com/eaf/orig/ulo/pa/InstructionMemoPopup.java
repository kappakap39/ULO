...
public class InstructionMemoPopup extends ORIGSubForm{
	private static transient Logger logger = Logger.getLogger(InstructionMemoPopup.class);
	@Override
	public void setProperties(HttpServletRequest arg0, Object arg1) {
