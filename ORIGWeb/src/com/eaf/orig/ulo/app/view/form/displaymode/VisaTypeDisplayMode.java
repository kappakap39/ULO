...
public class VisaTypeDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(VisaTypeDisplayMode.class);
...
//	PERSONAL_TYPE_SUPPLEMENTARY=S
	...
	public String displayMode(Object objectElement, HttpServletRequest request) {
		logger.debug("VisaTypeDisplayMode .....");
