...
public class BundleSMERatioFieldDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(BundleSMERatioFieldDisplayMode.class);
	@Override
	public String displayMode(Object objectElement, HttpServletRequest request) {
		...
		if(!Util.empty(bundleSMEM) && !Util.empty(bundleSMEM.getBorrowingType()) && 
				LOAN_TYPE_COBORROWER_JOINT.equals(bundleSMEM.getBorrowingType())) {
