...
public class CASaveFollowUpTopegaApplication extends ProcessActionHelper{
	private static transient Logger logger = Logger.getLogger(CASaveFollowUpTopegaApplication.class);
	...
	public Object processAction() {
		...
		try{
			logger.debug("CASaveFollowUpTopegaApplication..");	
