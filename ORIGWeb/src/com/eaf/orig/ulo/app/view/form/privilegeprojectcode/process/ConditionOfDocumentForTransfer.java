...
public class ConditionOfDocumentForTransfer extends ProcessActionHelper{
	private static transient Logger logger = Logger.getLogger(ConditionOfDocumentForTransfer.class);
	private String[] PROJECT_CODE = SystemConstant.getArrayConstant("PROJECT_CODE_OF_TRANSFER");
	@Override
	public Object processAction() {
		...
		try {
			...
			if(SystemConstant.getConstant("PRVLG_DOC_TYPE_TRANSFER").equals(privilegeProjectCodeDoc.getDocType())){
				return PROJECT_CODE;
			}
		} catch (Exception e) {
