...
public class PrevCompanyTitle extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(PrevCompanyTitle.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfo)) {
			...
			compareData.setValue(personalInfo.getPrevCompanyTitle());
