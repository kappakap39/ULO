...
public class Yearly50TawiIncome402 extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
			...
			for(IncomeCategoryDataM incomeObj: yearlyList) {
				if(incomeObj instanceof YearlyTawi50DataM) {
					...
					if(yearlyDataM.getId() != null) {
						...
						if(yearlyOrig != null &&  !CompareObject.compare(yearlyDataM.getIncome402(), yearlyOrig.getIncome402(),null)) {
