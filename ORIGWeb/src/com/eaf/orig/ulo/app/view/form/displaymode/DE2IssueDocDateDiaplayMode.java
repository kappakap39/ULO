...
public class DE2IssueDocDateDiaplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(DE2IssueDocDateDiaplayMode.class);
	@Override
