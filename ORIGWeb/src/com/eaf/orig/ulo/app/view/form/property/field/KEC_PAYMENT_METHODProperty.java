...
public class KEC_PAYMENT_METHODProperty  extends FieldPropertyHelper{
	private static transient Logger logger = Logger.getLogger(KEC_PAYMENT_METHODProperty.class);
	...
	public String validateFlag(HttpServletRequest request, Object objectForm) {
		logger.debug("KEC_PAYMENT_METHODProperty.validateFlag");
