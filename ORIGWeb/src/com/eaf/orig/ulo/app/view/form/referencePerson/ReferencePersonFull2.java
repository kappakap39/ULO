...
public class ReferencePersonFull2 extends ElementHelper {
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		String TH_TITLE_CODE = request.getParameter("TH_TITLE_CODE_"+refPerson);
		String TH_TITLE_DESC = request.getParameter("TH_TITLE_DESC_"+refPerson);
		...
		referencePerson.setThTitleCode(TH_TITLE_CODE);
