...
public class SUP_VISA_EXPIRE_DATEProperty extends FieldPropertyHelper {
	...
	private static transient Logger logger = Logger.getLogger(SUP_VISA_EXPIRE_DATEProperty.class);
	@Override
