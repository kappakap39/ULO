...
public class PayrollNoOfEmployee  extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
		...
		if(!Util.empty(payrollList) && incomeOrig != null) {
			for(IncomeCategoryDataM incomeTypeM: payrollList) {
				...
				if(payrollM.getId() != null) {
					...
					if(payrollOrig != null && payrollOrig.getNoOfEmployee() != payrollM.getNoOfEmployee()) {
