...
public class SUP_PAYMENT_METHODProperty  extends FieldPropertyHelper{
	private static transient Logger logger = Logger.getLogger(SUP_PAYMENT_METHODProperty.class);
	...
	public ArrayList<AuditDataM> auditForm(HttpServletRequest request,Object objectForm, Object lastObjectForm, Object objectValue) {
		...
		logger.debug("compare >> "+comparePayment);
		if(!comparePayment){
