...
public class Yearly50TawiMonth extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
			...
			for(IncomeCategoryDataM incomeObj: yearlyList) {
				if(incomeObj instanceof YearlyTawi50DataM) {
					...
					if(yearlyDataM.getId() != null) {
						...
						if(yearlyOrig != null && yearlyDataM.getMonth() != yearlyOrig.getMonth()) {
