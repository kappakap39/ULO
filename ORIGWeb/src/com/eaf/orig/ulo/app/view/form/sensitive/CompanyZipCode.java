...
public class CompanyZipCode extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(CompanyZipCode.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		String prefixAddress = CompareSensitiveFieldUtil.getPrefixAddress(personalInfoM,ADDRESS_TYPE_WORK);
		...
		.append(HtmlUtil.getFieldLabel(request, "ZIPCODE_"+ADDRESS_TYPE_WORK, "col-sm-4 col-md-5 control-label"))
		...
		.append(HtmlUtil.hidden(prefixHiddenFiled+"_REKEY_ADDRESS_TYPE", ADDRESS_TYPE_WORK))
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(address) || Util.empty(address.getZipcode())){
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"ZIPCODE_"+ADDRESS_TYPE_WORK));
		}*/
