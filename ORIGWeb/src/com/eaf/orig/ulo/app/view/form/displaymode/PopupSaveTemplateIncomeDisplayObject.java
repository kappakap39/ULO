...
public class PopupSaveTemplateIncomeDisplayObject extends FormDisplayObjectHelper{
	private static final Logger logger = Logger.getLogger(PopupSaveTemplateIncomeDisplayObject.class);
