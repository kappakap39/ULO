...
public class AdditionalServiceSubForm4 extends ORIGSubForm{
	private static transient Logger logger = Logger.getLogger(AdditionalServiceSubForm4.class);
	...
	public String renderSubformFlag(HttpServletRequest request,Object objectForm) {
		...
		if(!SystemConfig.getGeneralParam(GEN_PARAM_CC_PREMIER).contains(applicationTemplate) && !SystemConfig.getGeneralParam(GEN_PARAM_CC_WISDOM).contains(applicationTemplate)
		   && !SystemConfig.getGeneralParam(GEN_PARAM_CC_INFINITE).contains(applicationTemplate)){
