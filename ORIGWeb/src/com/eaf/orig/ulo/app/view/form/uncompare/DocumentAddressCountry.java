...
public class DocumentAddressCountry extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(DocumentAddressCountry.class);	
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			if(!Util.empty(address)) {
				...
				compareData.setValue(address.getCountry());
