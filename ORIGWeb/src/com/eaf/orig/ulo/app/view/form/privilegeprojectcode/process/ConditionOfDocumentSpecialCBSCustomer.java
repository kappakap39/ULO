...
public class ConditionOfDocumentSpecialCBSCustomer extends ProcessActionHelper{
	private static transient Logger logger = Logger.getLogger(ConditionOfDocumentSpecialCBSCustomer.class);
	private String[] PROJECT_CODE = SystemConstant.getArrayConstant("PROJECT_CODE_OF_CSB_CUSTOMER");
	@Override
	public Object processAction() {
		...
		try {
			...
			if(SystemConstant.getConstant("PRVLG_DOC_TYPE_CBS").equals(privilegeProjectCodeDoc.getDocType())){
				return PROJECT_CODE;
			}
		} catch (Exception e) {
