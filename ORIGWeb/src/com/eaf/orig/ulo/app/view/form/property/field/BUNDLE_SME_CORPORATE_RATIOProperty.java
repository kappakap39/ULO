...
public class BUNDLE_SME_CORPORATE_RATIOProperty extends FieldPropertyHelper {
	private static transient Logger logger = Logger.getLogger(BUNDLE_SME_CORPORATE_RATIOProperty.class);
	@Override
	...
	public HashMap<String,Object> validateForm(HttpServletRequest request, Object objectForm) {	
		logger.debug("BUNDLE_SME_CORPORATE_RATIOProperty.validateForm");
