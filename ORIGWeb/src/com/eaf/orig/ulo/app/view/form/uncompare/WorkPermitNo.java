...
public class WorkPermitNo extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(WorkPermitNo.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(personalInfoM.getWorkPermitNo());
