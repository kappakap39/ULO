...
public class PaymentAccountNo extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(PaymentAccountNo.class);
...
/*		PersonalInfoDataM relatedPersonalInfo = CompareSensitiveFieldUtil.getPersonalInfoByRefId(applicationGroup, compareData);
		...
		if(!Util.empty(paymentMethod)) {
			...
			paymentMethod.setAccountNo(FormatUtil.removeDash(acctNo));
		}
		return null;
	}
