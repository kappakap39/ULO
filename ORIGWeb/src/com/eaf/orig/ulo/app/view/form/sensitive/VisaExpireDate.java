...
public class VisaExpireDate extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(VisaExpireDate.class);
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(!Util.empty(personalInfoM) && !Util.empty(personalInfoM.getVisaExpDate())){
			if(DateValidateUtil.validateDate(personalInfoM.getVisaExpDate(), DateValidateUtil.FORMAT_DATE_VALIDATE,DateValidateUtil.EN)
					|| DateValidateUtil.validateDate(personalInfoM.getVisaExpDate(), DateValidateUtil.LIMIT_YEAR_DATE_VALIDATE,DateValidateUtil.EN)){
	...
	public String processElement(HttpServletRequest request,Object objectElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			if(!Util.empty(visaexp)){
				personalInfoM.setVisaExpDate(FormatUtil.toDate(visaexp, HtmlUtil.EN));
			}
		}		
		return null;
	}	
