...
public class Nationality  extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(Nationality.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		.append(HtmlUtil.dropdown(CompareSensitiveFieldUtil.getElementName(compareData),CompareSensitiveFieldUtil.getElementSuffix(compareData),"","","",FIELD_ID_NATIONALITY,"ALL_ALL_ALL",displayMode,
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(personalInfoM.getNationality());
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			String nationality = request.getParameter(paramName);
			personalInfoM.setNationality(nationality);
		}
		return null;
	}	
	@Override
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM) || Util.empty(personalInfoM.getNationality())) {
