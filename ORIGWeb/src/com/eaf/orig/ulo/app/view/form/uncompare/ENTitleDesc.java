...
public class ENTitleDesc extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(ENTitleDesc.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfo)) {
			...
			compareData.setValue(personalInfo.getEnTitleDesc());
