...
public class AdditionalServiceSubForm2 extends ORIGSubForm{
	private static transient Logger logger = Logger.getLogger(AdditionalServiceSubForm2.class);
	...
	public String renderSubformFlag(HttpServletRequest request,Object objectForm) {
		...
		if(SystemConfig.getGeneralParam(GEN_PARAM_CC_WISDOM).contains(applicationGroup.getApplicationTemplate())){
