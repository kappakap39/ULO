...
public class BIRTH_DATE_CONSENTProperty extends FieldPropertyHelper {
	private static transient Logger logger = Logger.getLogger(BIRTH_DATE_CONSENTProperty.class);
	...
	public ArrayList<AuditDataM> auditForm(HttpServletRequest request,Object objectForm, Object lastObjectForm, Object objectValue){		
		...
		logger.debug("BIRTH_DATE_CONSENTProperty getBirthDate: "+personalInfo.getBirthDate());
		logger.debug("BIRTH_DATE_CONSENTProperty lastpersonalInfo getBirthDate: "+lastpersonalInfo.getBirthDate());
		logger.debug("BIRTH_DATE_CONSENTProperty getBirthDate: "+personalInfo.getBirthDateConsent());
