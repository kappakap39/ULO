...
public class DocumentAddress extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(DocumentAddress.class);
...
//		String addressRefId = CompareSensitiveFieldUtil.getAddressRefId(personalInfoM,ADDRESS_TYPE_DOCUMENT);
		...
		.append(HtmlUtil.getFieldLabel(request, "ADDRESS_NO_"+ADDRESS_TYPE_DOCUMENT, "col-sm-4 col-md-5 control-label"))
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(address) || Util.empty(address.getAddress())) {
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"ADDRESS_NO_"+ADDRESS_TYPE_DOCUMENT));
		}*/
