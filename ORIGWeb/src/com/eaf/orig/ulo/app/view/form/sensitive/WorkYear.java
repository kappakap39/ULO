...
public class WorkYear extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(WorkYear.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		String labelDesc = LabelUtil.getText(request, "TOT_WORK")+"("+LabelUtil.getText(request, "TOT_WORK_YEAR")+")";
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(FormatUtil.display(personalInfoM.getTotWorkYear()));
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			BigDecimal totWorkYear = FormatUtil.toBigDecimal(request.getParameter(paramName),true);
			personalInfoM.setTotWorkYear(totWorkYear);
		}
		return null;
	}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM.getTotWorkYear())) {
