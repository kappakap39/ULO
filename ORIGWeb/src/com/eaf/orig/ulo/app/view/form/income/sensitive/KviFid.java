...
public class KviFid  extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
		...
		if(!Util.empty(kviList) && incomeOrig != null) {
			for(IncomeCategoryDataM incomeTypeM: kviList) {
				...
				if(kviM.getId() != null) {
					...
					if(kviOrig != null &&  !CompareObject.compare(kviM.getKviFid(), kviOrig.getKviFid(),null)) {
