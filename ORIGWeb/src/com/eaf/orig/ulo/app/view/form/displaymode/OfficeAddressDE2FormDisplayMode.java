...
public class OfficeAddressDE2FormDisplayMode extends DE2FormDisplayMode{
	private static transient Logger logger = Logger.getLogger(OfficeAddressDE2FormDisplayMode.class);
