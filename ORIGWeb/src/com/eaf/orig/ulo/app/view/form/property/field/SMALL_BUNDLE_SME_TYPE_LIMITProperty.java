...
public class SMALL_BUNDLE_SME_TYPE_LIMITProperty extends FieldPropertyHelper{
...
//		}
	...
	public HashMap<String,Object> validateForm(HttpServletRequest request, Object objectForm) {	
		logger.debug("SMALL_BUNDLE_SME_TYPE_LIMITProperty.validateForm");
		...
		if(!Util.empty(bundleM)) { 
			if(LOAN_TYPE_SINGLE.equals(bundleM.getBorrowingType())){
				if(Util.empty(bundleM.getTypeLimit())) {
					formError.error("TYPE_LIMIT",PREFIX_ERROR+LabelUtil.getText(request,"TYPE_LIMIT"));					
				}
			}
