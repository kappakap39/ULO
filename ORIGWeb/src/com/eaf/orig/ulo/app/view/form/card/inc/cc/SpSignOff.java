package com.eaf.orig.ulo.app.view.form.card.inc.cc;
...
public class SpSignOff extends ElementHelper implements ElementInf{
	...
	private static final String PRODUCT_CRADIT_CARD = SystemConstant.getConstant("PRODUCT_CRADIT_CARD");
	String subformId ="KCC_SP_SIGN_OFF_SUBFORM";
	@Override
	public String getElement(HttpServletRequest request, Object objectElement) {
		return "/orig/ulo/product/kcc/SpSignOffSubForm.jsp";
	}
	...
	public  HashMap<String,Object>  validateElement(HttpServletRequest request, Object appForm) {
		...
		formError.mandatory(subformId, "SP_SIGN_OFF_DATE", "SP_SIGN_OFF_DATE_CC","", spSignOffDate, request);
