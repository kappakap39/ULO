...
public class ConditionOfDocumentForOverride extends ProcessActionHelper {
	private static transient Logger logger = Logger.getLogger(ConditionOfDocumentForOverride.class);
	private String[] PROJECT_CODE = SystemConstant.getArrayConstant("PROJECT_CODE_OF_OVERRIDE");
	@Override
	public Object processAction() {
		...
		try {
			...
			if(!Util.empty(privilegeProjectCodeDoc)){
				if(SystemConstant.getConstant("PRVLG_DOC_TYPE_EXCEPTION").equals(privilegeProjectCodeDoc.getDocType())){
					return PROJECT_CODE;
				}
			}
