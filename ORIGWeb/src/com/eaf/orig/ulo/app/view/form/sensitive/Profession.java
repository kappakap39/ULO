...
public class Profession extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(Profession.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {
		...
		.append(HtmlUtil.hidden("REKEY_PROFESSION_CODE_"+CompareSensitiveFieldUtil.getElementSuffix(compareData), ""))
		.append(HtmlUtil.popupList(CompareSensitiveFieldUtil.getElementName(compareData), CompareSensitiveFieldUtil.getElementSuffix(compareData), "", "", "20", displayMode
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(personalInfoM.getProfession());
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		PersonalInfoDataM personalInfoM = CompareSensitiveFieldUtil.getPersonalInfoByUniqueId(applicationGroup, compareData);
		if(!Util.empty(personalInfoM)) {
			String profession = request.getParameter("REKEY_PROFESSION_CODE_"+CompareSensitiveFieldUtil.getElementSuffix(compareData));
			logger.debug("profession>>>"+profession);
			personalInfoM.setProfession(profession);
		}
		return null;
	}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM.getProfession())) {
