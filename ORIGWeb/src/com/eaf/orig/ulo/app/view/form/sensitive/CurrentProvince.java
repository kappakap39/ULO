...
public class CurrentProvince extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(CurrentProvince.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		.append(HtmlUtil.getFieldLabel(request, "PROVINCE_"+ADDRESS_TYPE_CURRENT, "col-sm-4 col-md-5 control-label"))
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(address) || Util.empty(address.getProvinceDesc())) {
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"PROVINCE_"+ADDRESS_TYPE_CURRENT));
		}*/
