...
public class PayrollDate extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(PayrollDate.class);
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(FormatUtil.display(personalInfoM.getPayrollDate()));
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			String payrollDate = request.getParameter(paramName);
			personalInfoM.setPayrollDate(payrollDate);
		}
		return null;
	}
