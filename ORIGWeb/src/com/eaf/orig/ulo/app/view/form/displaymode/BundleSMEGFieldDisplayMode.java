...
public class BundleSMEGFieldDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(BundleSMEGFieldDisplayMode.class);
	@Override
	public String displayMode(Object objectElement, HttpServletRequest request) {
		...
		if(!Util.empty(bundleSMEM) && !Util.empty(bundleSMEM.getBorrowingType()) && 
				!LOAN_TYPE_COBORROWER.equals(bundleSMEM.getBorrowingType())) {
