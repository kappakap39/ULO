...
public class HomeAddressDE2FormDisplayMode extends DE2FormDisplayMode{
	private static transient Logger logger = Logger.getLogger(HomeAddressDE2FormDisplayMode.class);
