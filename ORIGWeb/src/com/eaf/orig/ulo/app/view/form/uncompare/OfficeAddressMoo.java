...
public class OfficeAddressMoo extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(OfficeAddressMoo.class);	
