...
public class ENMiddleName extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(ENMiddleName.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfo)) {
			...
			compareData.setValue(personalInfo.getEnMidName());
