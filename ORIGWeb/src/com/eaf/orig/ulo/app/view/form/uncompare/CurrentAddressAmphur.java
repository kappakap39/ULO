...
public class CurrentAddressAmphur  extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(CurrentAddressAmphur.class);	
