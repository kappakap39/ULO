...
public class PrevWorkYear extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(PrevWorkYear.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		String labelDesc = LabelUtil.getText(request, "PREV_WORK")+"("+LabelUtil.getText(request, "TOT_WORK_YEAR")+")";
		
		HTML.append("<div class='col-sm-12'>")
			.append("<div class='form-group'>")
			.append(HtmlUtil.geCustomFieldLabel(labelDesc, "col-sm-4 col-md-5 control-label"))
			.append(HtmlUtil.numberBox(CompareSensitiveFieldUtil.getElementName(compareData),CompareSensitiveFieldUtil.getElementSuffix(compareData), null,"", "##","","", true, "2",
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(Util.empty(personalInfoM.getPrevWorkYear())?"":FormatUtil.display(personalInfoM.getPrevWorkYear()));
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			BigDecimal prevWorkYear = FormatUtil.toBigDecimal(request.getParameter(paramName),true);
			personalInfoM.setPrevWorkYear(prevWorkYear);
		}
		return null;
	}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM.getPrevWorkYear())) {
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"PREV_WORK"));
		}*/
