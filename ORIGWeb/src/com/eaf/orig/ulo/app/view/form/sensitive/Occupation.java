...
public class Occupation extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(Occupation.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		.append(HtmlUtil.hidden("REKEY_OCCUPATION_CODE_"+CompareSensitiveFieldUtil.getElementSuffix(compareData), ""))
		.append(HtmlUtil.popupList(CompareSensitiveFieldUtil.getElementName(compareData),CompareSensitiveFieldUtil.getElementSuffix(compareData),"","","20",
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		PersonalInfoDataM personalInfoM = CompareSensitiveFieldUtil.getPersonalInfoByUniqueId(applicationGroup, compareData);
		if(!Util.empty(personalInfoM)) {				
			String occupation = request.getParameter("REKEY_OCCUPATION_CODE_"+CompareSensitiveFieldUtil.getElementSuffix(compareData));
			if(OCCUPATION_OTHER.equals(occupation)){
				String textOccupation = request.getParameter("REKEY_OCCUPATION_"+CompareSensitiveFieldUtil.getElementSuffix(compareData));
				personalInfoM.setOccpationOther(textOccupation);
			}
			logger.debug("occupation>>>"+occupation);
			personalInfoM.setOccupation(occupation);
		}
		return null;
	}	
	@Override
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM) || Util.empty(personalInfoM.getOccupation())) {
