...
public class NCBReportKPLSubFormElement extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(NCBReportKPLSubFormElement.class);	
	@Override
	public String getElement(HttpServletRequest request, Object objectElement) {
		...
		return "/orig/ulo/subform/ncb/NCBReportKPLSubForm.jsp?TRACKING_CODE="+TRACKING_CODE+"&PERSONAL_ID="+PERSONAL_ID;
	}
	@Override
