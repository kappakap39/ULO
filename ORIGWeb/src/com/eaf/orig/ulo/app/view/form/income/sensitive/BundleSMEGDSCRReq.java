...
public class BundleSMEGDSCRReq  extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
	...
	public HashMap<String,Object> compareField(HttpServletRequest request, Object objectElement){
		...
		if(!Util.empty(bundleOrig)){
			if( !CompareObject.compare(bundleSMEM.getgDscrReq(), bundleOrig.getgDscrReq(),null)){
