...
public class SupPaymentMethod extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(SupPaymentMethod.class);
...
//		String productRefId = CompareSensitiveFieldUtil.getProductRefId(personalInfoM, product);
		...
		String labelDesc = LabelUtil.getText(request, "PAYMENT_METHOD")+"("+LabelUtil.getText(request, "PRODUCT_"+product)+")";
