...
public class IAListPersonalInfoSubformDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(IAListPersonalInfoSubformDisplayMode.class);
