...
public class CcCardInfo extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(CcCardInfo.class);
	private static final String PRODUCT_CRADIT_CARD = SystemConstant.getConstant("PRODUCT_CRADIT_CARD");
	
	@Override
	public String getElement(HttpServletRequest request, Object objectElement) {
		return "/orig/ulo/subform/increase/CcCardInfo.jsp?PRODUCT="+PRODUCT_CRADIT_CARD;
	}
