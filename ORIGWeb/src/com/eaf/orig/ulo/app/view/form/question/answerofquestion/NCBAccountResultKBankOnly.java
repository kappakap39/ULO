...
public class NCBAccountResultKBankOnly  extends FormHelper implements FormAction {
	private static transient Logger logger = Logger.getLogger(NCBAccountResultKBankOnly.class);
