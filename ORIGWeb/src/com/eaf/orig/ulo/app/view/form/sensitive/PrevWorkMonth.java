...
public class PrevWorkMonth extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(PrevWorkMonth.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {	
		...
		String labelDesc = LabelUtil.getText(request, "PREV_WORK")+"("+LabelUtil.getText(request, "TOT_WORK_MONTH")+")";
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(Util.empty(personalInfoM.getPrevWorkMonth())?"":FormatUtil.display(personalInfoM.getPrevWorkMonth()));
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)){
			...
			BigDecimal prevWorkMonth = FormatUtil.toBigDecimal(request.getParameter(paramName),true);
			personalInfoM.setPrevWorkMonth(prevWorkMonth);
		}
		return null;
	}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM) || Util.empty(personalInfoM.getPrevWorkMonth())) {
