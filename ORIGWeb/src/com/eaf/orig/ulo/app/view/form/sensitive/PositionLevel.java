...
public class PositionLevel extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(PositionLevel.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement){		
		...
		.append(HtmlUtil.dropdown(CompareSensitiveFieldUtil.getElementName(compareData), CompareSensitiveFieldUtil.getElementSuffix(compareData), compareData.getFieldNameType(), "", "", FIELD_ID_POSITION_LEVEL,"ALL_ALL_ALL",
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(personalInfoM.getPositionLevel());
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			String positionLevel = request.getParameter(paramName);
			personalInfoM.setPositionLevel(positionLevel);
		}
		return null;
	}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(!Util.empty(personalInfoM) && !GOVERNMENT_OFFICER.equals(personalInfoM.getOccupation())
				 && Util.empty(personalInfoM.getPositionLevel())) {
