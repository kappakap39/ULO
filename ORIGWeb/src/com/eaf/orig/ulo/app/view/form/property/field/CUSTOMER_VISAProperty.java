...
public class CUSTOMER_VISAProperty extends FieldPropertyHelper{
	...
	private static transient Logger logger = Logger.getLogger(CUSTOMER_VISAProperty.class);
	@Override
	...
	public String validateFlag(HttpServletRequest request, Object objectForm) {
		logger.debug("CUSTOMER_TYPEProperty.validateFlag");
		PersonalInfoDataM personalInfo = null;
		
		personalInfo = (PersonalInfoDataM) masterObjectForm;
