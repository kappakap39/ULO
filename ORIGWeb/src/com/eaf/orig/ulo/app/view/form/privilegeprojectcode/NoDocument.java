...
public class NoDocument extends ElementHelper implements ElementInf{
	...
	public String getElement(HttpServletRequest request, Object objectElement) {
		...
		htmlTag.append(			"<label for='01_DOCUMENT_TYPE'>" + LabelUtil.getText(request,"NO_DOCUMENT") + "</label>");	
		htmlTag.append("					</div>");
		htmlTag.append("				</div>");
		htmlTag.append("			</div>");
		htmlTag.append("		</div>");
