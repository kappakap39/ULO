...
public class CurentAddressMoo  extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(CurentAddressMoo.class);	
