...
public class HisHerNoCC extends ElementHelper implements ElementInf{
	...
	public String getElement(HttpServletRequest request,Object objectElement) {	
		logger.debug("Class name >> HisHerNoCC");
...
//						compareData.setFieldName(getImplementId()+CompareDataM.MARKER+cardCodeRefId);
	...
	public String processElement(HttpServletRequest request,Object objectElement){
		...
		if(!Util.empty(cardM)) {
			...
			String hisher = request.getParameter(paramName);
			cardM.setMembershipNo(hisher);
		}	
