...
public class DocumentZipCode extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(DocumentZipCode.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {			
		...
		.append(HtmlUtil.getFieldLabel(request, "ZIPCODE_"+ADDRESS_TYPE_DOCUMENT, "col-sm-4 col-md-5 control-label"))
		/*.append(HtmlUtil.numberBox(CompareSensitiveFieldUtil.getElementName(compareData),CompareSensitiveFieldUtil.getElementSuffix(compareData),null,"", "#####", "","",true, "5", 
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			if(!Util.empty(address)) {
				...
				compareData.setValue(address.getZipcode());
	...
	/*	String PREFIX_ERROR = MessageErrorUtil.getText(request,"PREFIX_ERROR");
		...
		if(Util.empty(address) || Util.empty(address.getZipcode())) {
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"ZIPCODE_"+ADDRESS_TYPE_DOCUMENT));
		}*/
