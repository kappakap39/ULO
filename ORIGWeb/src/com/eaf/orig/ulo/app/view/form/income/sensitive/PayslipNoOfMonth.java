...
public class PayslipNoOfMonth  extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
		...
		if(!Util.empty(payslipList) && incomeOrig != null) {
			for(IncomeCategoryDataM incomeTypeM: payslipList) {
				...
				if(payslipM.getId() != null) {
					...
					if(payslipOrig != null && payslipOrig.getNoMonth() != payslipM.getNoMonth()) {
