...
public class DocumentAddressTambol extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(DocumentAddressTambol.class);	
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			if(!Util.empty(address)) {
				...
				compareData.setValue(address.getTambol());
