...
public class HisAndHerPopup extends ORIGSubForm {
	...
	private String subformId = "HIS_HER_POPUP";
...
//		formError.mandatory(subformId,"SEND_DOC",personalInfo.getMailingAddress(),request);
		formError.mandatory(subformId,"HIS_HER_NO",Card.getMembershipNo(),request);
	...
	public void displayValueForm(HttpServletRequest request, Object objectForm) {	
		...
		card.setMembershipNo(formValue.getValue("HIS_HER_NO_CC", "HIS_HER_NO_CC_"+cardCodeRefId, card.getMembershipNo()));
