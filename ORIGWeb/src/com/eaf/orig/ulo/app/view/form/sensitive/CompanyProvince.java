...
public class CompanyProvince extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(CompanyProvince.class);
	...
	public String getElement(HttpServletRequest request,Object objectElement) {		
		...
		.append(HtmlUtil.getFieldLabel(request, "PROVINCE_"+ADDRESS_TYPE_WORK, "col-sm-4 col-md-5 control-label"))
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(address)) {
			...
			String provinceDesc = FormatUtil.removeDash(request.getParameter(paramName));
			address.setProvinceDesc(provinceDesc);*/
			String prefixAddress = CompareSensitiveFieldUtil.getPrefixAddress(personalInfoM,ADDRESS_TYPE_WORK);
	...
	/*	String PREFIX_ERROR = MessageErrorUtil.getText(request,"PREFIX_ERROR");
		...
		if(Util.empty(address) || Util.empty(address.getProvinceDesc())) {
			formError.error(compareData.getFieldName(),PREFIX_ERROR+LabelUtil.getText(request,"PROVINCE_"+ADDRESS_TYPE_WORK));
		}*/
