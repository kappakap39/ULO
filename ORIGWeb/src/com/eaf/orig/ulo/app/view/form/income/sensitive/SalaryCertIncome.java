...
public class SalaryCertIncome  extends CompareIncomeHelper implements CompareIncomeInf{
	@Override
		...
		if(!Util.empty(salaryCertList)) {
			for(IncomeCategoryDataM incomeObj: salaryCertList) {
				...
				if(salaryCertM.getId() != null) {
					...
					if(salaryCertOrig != null &&  !CompareObject.compare(salaryCertM.getIncome(), salaryCertOrig.getIncome(),null)) {
