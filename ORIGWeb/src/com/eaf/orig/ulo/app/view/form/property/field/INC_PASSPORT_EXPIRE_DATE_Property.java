...
public class INC_PASSPORT_EXPIRE_DATE_Property extends FieldPropertyHelper {
	String PERSONAL_TYPE_APPLICANT = SystemConstant.getConstant("PERSONAL_TYPE_APPLICANT");
	private static transient Logger logger = Logger.getLogger(INC_PASSPORT_EXPIRE_DATE_Property.class);
