...
public class SEND_DOC_DE1_1DefualtValue extends RekeyDE1_1MakerDisplayValue{
	private static final transient Logger logger = Logger.getLogger(SEND_DOC_DE1_1DefualtValue.class);
	...
	public Object getValue(String elementFieldId, Object elementValue,HttpServletRequest request) {
		...
		logger.debug("SEND_DOC_DE1_1DefualtValue>>>"+elementValue);
		return elementValue;
	}
}
