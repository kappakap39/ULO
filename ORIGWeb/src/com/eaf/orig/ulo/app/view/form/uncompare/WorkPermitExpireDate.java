...
public class WorkPermitExpireDate extends ElementHelper implements ElementInf {
	private static transient Logger logger = Logger.getLogger(WorkPermitExpireDate.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(FormatUtil.display(personalInfoM.getWorkPermitExpDate(),HtmlUtil.EN));
