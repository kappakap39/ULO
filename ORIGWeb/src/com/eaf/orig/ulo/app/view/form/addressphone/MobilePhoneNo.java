...
public class MobilePhoneNo extends ElementHelper{
	...
	public String getElement(HttpServletRequest request, Object objectElement) {
		...
		HTML.append(" <tr> ")
			...
			.append(" 	</td>")
			.append(" 	<td>"+FormatUtil.getMobileNo(personalInfo.getMobileNo())+"</td>")
			.append("	<td>"+HtmlUtil.hidden("PHONE_NO", FormatUtil.getMobileNo(personalInfo.getMobileNo()))+"</td>")
			.append(" 	<td></td>")
			.append(" </tr> ");
	...
	public String renderElementFlag(HttpServletRequest request, Object objectElement) {
		...
		if(VERIFY_CUSTOMER_DISPLAY.equals(DISPLAY)){
			PersonalInfoDataM personalInfo = (PersonalInfoDataM)objectElement;
			if(!Util.empty(personalInfo) && !Util.empty(personalInfo.getMobileNo())){
				personalInfo.addVerCusPhoneNo(personalInfo.getMobileNo());
