...
public class VerifyHrTotalWorkFormDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(VerifyHrTotalWorkFormDisplayMode.class);
