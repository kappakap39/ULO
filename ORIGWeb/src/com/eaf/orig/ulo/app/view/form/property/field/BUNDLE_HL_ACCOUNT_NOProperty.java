...
public class BUNDLE_HL_ACCOUNT_NOProperty extends FieldPropertyHelper {
	...
	public String validateFlag(HttpServletRequest request, Object objectForm) {
		...
		if (!Util.empty(bundleHL)) {
			String ACCOUNT_NO = bundleHL.getAccountNo();
	...
	public HashMap<String, Object> validateForm(HttpServletRequest request, Object objectForm) {
		logger.debug("BUNDLE_HL_ACCOUNT_NOProperty.validateForm");
		String elementFieldId = "BUNDLING_HL_ACCOUNT_NO";
		String PREFIX_ERROR = MessageErrorUtil.getText(request, "PREFIX_ERROR");

		BundleHLDataM bundleHL = (BundleHLDataM) objectForm;
		String ACCOUNT_NO = bundleHL.getAccountNo();
		ACCOUNT_NO = FormatUtil.removeDash(ACCOUNT_NO);
		String TYPE_LIMIT = ACCOUNT_TYPE_LOAN;
