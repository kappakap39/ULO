...
public class PaymentCashdayOne extends ElementHelper implements ElementInf {
	...
	//	return	"/orig/ulo/product/kec/CashDay1SubForm.jsp";
		return "/orig/ulo/subform/question/PaymentCashdayOne.jsp";
	}
