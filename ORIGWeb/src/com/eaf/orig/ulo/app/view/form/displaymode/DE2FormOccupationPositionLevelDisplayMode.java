...
public class DE2FormOccupationPositionLevelDisplayMode extends FormDisplayModeHelper{
	private static transient Logger logger = Logger.getLogger(DE2FormOccupationPositionLevelDisplayMode.class);
