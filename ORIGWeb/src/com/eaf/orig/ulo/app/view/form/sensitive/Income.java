...
public class Income extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(Income.class);
	...
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfoM)) {
			...
			compareData.setValue(FormatUtil.display(personalInfoM.getSalary()));
	...
	public String processElement(HttpServletRequest request,Object objectElement) {
		...
		if(!Util.empty(personalInfoM)) {
			...
			BigDecimal salary = FormatUtil.toBigDecimal(request.getParameter(paramName),true);
			personalInfoM.setSalary(salary);
		}
	...
	public HashMap<String,Object> validateElement(HttpServletRequest request, Object objectElement){
		...
		if(Util.empty(personalInfoM) || Util.empty(personalInfoM.getSalary())) {
