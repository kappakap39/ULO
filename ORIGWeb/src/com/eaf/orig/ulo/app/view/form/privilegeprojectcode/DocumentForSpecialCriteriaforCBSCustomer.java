...
public class DocumentForSpecialCriteriaforCBSCustomer extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(DocumentForSpecialCriteriaforCBSCustomer.class);	
	@Override
	public String getElement(HttpServletRequest request, Object objectElement) {
		...
		htmlTag.append(			"<label for='02_DOCUMENT_TYPE'>" + LabelUtil.getText(request,"DOCUMENT_FOR_SPECIAL_CRITERIA_FOR_CBS_CUSTOMER") + "</label>");	
		htmlTag.append("					</div>");
		htmlTag.append("				</div>");
		htmlTag.append("			</div>");
		htmlTag.append("		</div>");
