...
public class DVFormDisplayObjectCustomer extends FormDisplayObjectHelper{
	private static transient Logger logger = Logger.getLogger(DVFormDisplayObjectCustomer.class);
	@Override
	public String getObjectFormMode(String objectId, String objectType,Object objectElement) {
		...
		if(!Util.empty(personalInfo)){
			...
			if(!Util.empty(verificationResult)){
				String resultCode = VerifyUtil.VerifyResult.getVerifyCustomerResult(applicationGroup);
