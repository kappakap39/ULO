...
public class ENTitleCode extends ElementHelper implements ElementInf{
	private static transient Logger logger = Logger.getLogger(ENTitleCode.class);
	@Override
	public <T>Object getObjectElement(HttpServletRequest request,Object objectForm,FieldElement fieldElement){
		...
		if(!Util.empty(personalInfo)) {
			...
			compareData.setValue(personalInfo.getEnTitleCode());
