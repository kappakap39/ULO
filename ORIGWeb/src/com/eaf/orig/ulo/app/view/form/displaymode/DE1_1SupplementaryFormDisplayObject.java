...
public class DE1_1SupplementaryFormDisplayObject extends FormDisplayObjectHelper{
	private static transient Logger logger = Logger.getLogger(DE1_1SupplementaryFormDisplayObject.class);
...
//		logger.debug("COVERPAGE_TYPE : "+applicationGroup.getCoverpageType());
		...
		logger.debug("SupplementaryFormDisplayObject add sup button displayMode >>"+displayMode);
		return displayMode;
	}
