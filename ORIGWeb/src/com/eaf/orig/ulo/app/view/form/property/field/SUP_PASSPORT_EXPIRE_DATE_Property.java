...
public class SUP_PASSPORT_EXPIRE_DATE_Property extends FieldPropertyHelper {
	...
	private static transient Logger logger = Logger.getLogger(SUP_PASSPORT_EXPIRE_DATE_Property.class);
	@Override
