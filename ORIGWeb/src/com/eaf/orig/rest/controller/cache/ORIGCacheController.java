package com.eaf.orig.rest.controller.cache;
...
public class ORIGCacheController {
	private static transient Logger logger = Logger.getLogger(ORIGCacheController.class);
