 ...
 */
public class LoadDealerCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadDealerCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        logger.debug("pay_dealer = "+pay_dealer);
        ...
        try {
			...
			sql.append("SELECT DEACDE, THNAME, ENNAME ");
			sql.append("FROM HPTBHP29 ");
            
			if(!ORIGUtility.isEmptyString(pay_dealer)){
			    sql.append("WHERE DEACDE = ? ");
			    valueListM.setString(++index,pay_dealer);
			    isFrist = false;
