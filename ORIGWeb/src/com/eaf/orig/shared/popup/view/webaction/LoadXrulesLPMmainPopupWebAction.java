 ...
 * @author Sankom
 *
 * Type: LoadXrulesLPMmainPopupWebAction
 */
public class LoadXrulesLPMmainPopupWebAction extends WebActionHelper implements
        WebAction {
    private static Logger log= (Logger) Logger
    .getLogger(LoadXrulesLPMmainPopupWebAction.class);
    /* (non-Javadoc)
