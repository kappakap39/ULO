 ...
 * @author weeraya
 *
 * Type: LoadDealerWebAction
 */
public class LoadDealerWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadDealerWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        String dealer = getRequest().getParameter("dealer");
        ...
        try {
			...
			if(!ORIGUtility.isEmptyString(dealer)){
			    sql.append("WHERE DEACDE = ? ");
			    valueListM.setString(++index,dealer);
			...
			valueListM.setSearchAction("LoadDealer");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, dealer);
            }
