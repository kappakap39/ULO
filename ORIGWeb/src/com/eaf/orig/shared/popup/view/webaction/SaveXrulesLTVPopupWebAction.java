 ...
 * @author wichaya
 *
 * Type: SaveXrulesLTVPopupWebAction
 */
public class SaveXrulesLTVPopupWebAction extends WebActionHelper implements WebAction {
    private static Logger log = (Logger) Logger.getLogger(SaveXrulesLTVPopupWebAction.class);
    /* (non-Javadoc)
    ...
    public boolean preModelRequest() {
        log.debug("SaveXrulesLTVPopupWebAction-->preModelRequest");
        ...
        String ltvResult = getRequest().getParameter("ltvResult");
        log.debug("Execute ltvResult Xrules Reuslt ="+ltvResult);
        xRulesVerification.setLtvResult(ltvResult);
        
        getRequest().getSession().setAttribute("execResult",ltvResult);
        getRequest().getSession().setAttribute("xrulseExecuteService",String.valueOf(XRulesConstant.ServiceID.LTV));
