 ...
 *
 * Type: LoadReportCMRCodeWebAction
 */
public class LoadReptCmrCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadReptCmrCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, tcmr_code);
            }
