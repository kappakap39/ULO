 ...
 */
public class LoadXrulesBlacklistCustomerPopupWebAction extends WebActionHelper
		implements WebAction {
    private static Logger log= (Logger) Logger
    .getLogger(LoadXrulesBlacklistCustomerPopupWebAction.class);
	/* (non-Javadoc)
	...
	public boolean preModelRequest() {
        ...
        if(personalTypeParam!=null&&!"".equals(personalTypeParam)&&!personalTypeParam.equals(personalType)){
            log.debug("Session personalType not equal param");
