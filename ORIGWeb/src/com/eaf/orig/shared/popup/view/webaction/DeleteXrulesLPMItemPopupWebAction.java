 ...
 * @author Sankom
 *
 * Type: DeleteXrulesLPMItemPopupWebAction
 */
public class DeleteXrulesLPMItemPopupWebAction extends WebActionHelper
        implements WebAction {
    private static Logger log = (Logger) Logger
    .getLogger(DeleteXrulesLPMItemPopupWebAction.class);
    /* (non-Javadoc)
    ...
    public boolean preModelRequest() {
        ...
        //String itemIndex=getRequest().getParameter("lpmItemIndex");      
        log.debug("DeleteXrulesLPMItemPopupWebAction-->preModelRequest");
            ...
            int removeCount=0;
             for(int i=0;i<vLPMDataM.size();i++){             
                // update LPM Input
                 ...
                 if(OrigConstant.ORIG_FLAG_Y.equalsIgnoreCase(lpmFlag)){
                     vLPMDataM.remove((i-removeCount));
                     removeCount++;
                 }                 
             }                         
        }                 
