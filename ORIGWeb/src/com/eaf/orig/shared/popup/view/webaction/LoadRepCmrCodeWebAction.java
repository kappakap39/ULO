 ...
 */
public class LoadRepCmrCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadRepCmrCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			valueListM.setSearchAction("LoadRepCmrCode");
