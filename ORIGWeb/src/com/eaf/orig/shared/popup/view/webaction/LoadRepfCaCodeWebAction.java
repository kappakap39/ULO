 ...
 */
public class LoadRepfCaCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadRepfCaCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			if(!ORIGUtility.isEmptyString(fca_code)){
			    sql.append("WHERE UPPER(INTCHK) = UPPER(?) ");
			    valueListM.setString(++index,fca_code);
			    isFrist = false;
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, fca_code);
            }
