 ...
 */
public class LoadLPMLoanTypeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadLPMLoanTypeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			sql.append("AND L.FIELD_ID = 24");
            
			if(!ORIGUtility.isEmptyString(loanType_code)){
			    sql.append("AND  UPPER(L.CHOICE_NO) = ? ");
			    valueListM.setString(++index, loanType_code.toUpperCase());
			...
			valueListM.setSearchAction("LoadLPMLoanType");
