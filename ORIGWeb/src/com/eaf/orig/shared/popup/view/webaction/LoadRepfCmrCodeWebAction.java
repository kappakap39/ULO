 ...
 */
public class LoadRepfCmrCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadRepfCmrCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			if(!ORIGUtility.isEmptyString(fcmr_code)){
			    sql.append("WHERE UPPER(LOAN_OFFICER) = UPPER(?) ");
			    valueListM.setString(++index,fcmr_code);
			    isFrist = false;
			...
			valueListM.setSearchAction("LoadRepfCmrCode");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, fcmr_code);
            }
