 ...
 * @author weeraya
 *
 * Type: LoadCategoryWebAction
 */
public class LoadCategoryWebAction extends WebActionHelper implements WebAction {
    Logger logger = Logger.getLogger(LoadCategoryWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			sql.append("SELECT CATEGORY, TH_DESC, EN_DESC ");
			sql.append("FROM MS_CAR_CATEGORY_TYPE ");
            
			if(!ORIGUtility.isEmptyString(car_category)){
			    sql.append("WHERE CATEGORY = ? ");
			    valueListM.setString(++index,car_category);
			...
			valueListM.setSearchAction("LoadCategory");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, car_category);
            }
