 ...
 * @author weeraya
 *
 * Type: LoadCarBrandWebAction
 */
public class LoadCarBrandWebAction extends WebActionHelper implements WebAction {
    Logger logger = Logger.getLogger(LoadCarBrandWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			sql.append("SELECT BRAND, TH_DESC, EN_DESC ");
			...
			valueListM.setSearchAction("LoadCarBrand");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, car_brand);
            }
