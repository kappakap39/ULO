 ...
 */
public class LoadReptOfficeCodeWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadReptOfficeCodeWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        try {
			...
			if(!ORIGUtility.isEmptyString(toffice_code)){
			    sql.append("WHERE UPPER(OFFCDE) = UPPER(?) ");
			    valueListM.setString(++index,toffice_code);
			    isFrist = false;
			...
			valueListM.setSearchAction("LoadReptOfficeCode");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, toffice_code);
            }
