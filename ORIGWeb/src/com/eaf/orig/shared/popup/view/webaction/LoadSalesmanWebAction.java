 ...
 * @author weeraya
 *
 * Type: LoadSalesmanWebAction
 */
public class LoadSalesmanWebAction extends WebActionHelper implements WebAction {
    private static Logger logger = Logger.getLogger(LoadSalesmanWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        String salesman = getRequest().getParameter("salesman");
        ...
        try {
			...
			if(!ORIGUtility.isEmptyString(salesman)){
			    sql.append("WHERE SELLCDE = ? ");
			    valueListM.setString(++index,salesman);
			...
			valueListM.setSearchAction("LoadSalesman");
            ...
            if(!ORIGUtility.isEmptyString(code)){
            	...
            	//getRequest().getSession().setAttribute(ValueListWebAction.VALUE_LIST_SEARCH_CODE, salesman);
            }
