 ...
 * @author wichaya
 *
 * Type: LoadXrulesEligibilityWebAction
 */
public class LoadXrulesEligibilityWebAction extends WebActionHelper implements WebAction {
    private static Logger log= (Logger) Logger.getLogger(LoadXrulesEligibilityWebAction.class);
    /* (non-Javadoc)
    ...
    public boolean preModelRequest() {
        String strServiceId=getRequest().getParameter("serviceid");
        log.debug("LoadXrulesEligibilityWebAction-->preModelRequest  service id"+strServiceId);
