 ...
 * @author weeraya
 *
 * Type: LoadBlackListSourceWebAction
 */
public class LoadBlackListSourceWebAction extends WebActionHelper implements WebAction {
    Logger logger = Logger.getLogger(LoadBlackListSourceWebAction.class);
    ...
    public boolean preModelRequest() {
        ...
        logger.debug("blckSource = "+blckSource);
        ...
        try {
			...
			sql.append("AND L.FIELD_ID = 23");
            
			if(!ORIGUtility.isEmptyString(blckSource)){
			    sql.append("AND L.CHOICE_NO = ? ");
			    valueListM.setString(++index,blckSource);
			...
			valueListM.setSearchAction("LoadBlackListSource");
