 ...
 */
public class MandatoryScoreServlet extends HttpServlet implements Servlet {
    Logger logger = Logger.getLogger(MandatoryScoreServlet.class);

    /**
     *  
     */
    public MandatoryScoreServlet() {
        super();
    }

    public void doPost(HttpServletRequest request, HttpServletResponse resp)
            throws ServletException, IOException {
        logger.debug("<<<<<<< Start MandatoryScoreServlet >>>>>>>");
        ...
        try{
	        ...
	        //get Verification
	        ORIGMandatoryVerificationErrorUtil mandatoryScoreErrorUtil = ORIGMandatoryVerificationErrorUtil
	                .getInstance();
	        ...
	        if (OrigConstant.CUSTOMER_TYPE_INDIVIDUAL
	            ...
	            isError =   mandatoryScoreErrorUtil
	                            .getErrorMessageScoreIndividual(request);
	        } else if (OrigConstant.CUSTOMER_TYPE_CORPORATE
	                .equalsIgnoreCase(personalInfoDataM.getCustomerType())) {
	            isError =   mandatoryScoreErrorUtil
	                            .getErrorMessageScoreCorporate(request);
	        } else if (OrigConstant.CUSTOMER_TYPE_FOREIGNER
	                .equalsIgnoreCase(personalInfoDataM.getCustomerType())) {
	            isError =   mandatoryScoreErrorUtil
	                            .getErrorMessageScoreForeigner(request);
	        }        
