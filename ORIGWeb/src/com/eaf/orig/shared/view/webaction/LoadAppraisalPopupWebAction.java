 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class LoadAppraisalPopupWebAction extends WebActionHelper implements WebAction {
    Logger logger = Logger.getLogger(LoadAppraisalPopupWebAction.class); 
    /* (non-Javadoc)
    ...
    public boolean preModelRequest() {
        logger.debug("+++++LoadAppraisalPopupWebAction+++++");
		...
		String formID = "APPRAISAL_POPUP_FORM";
       ...
       // if( OrigConstant.COBORROWER_FLAG_ACTIVE.equals(coborrwerFlag)){
		...
		getRequest().getSession().setAttribute("APPRAISAL_POPUP_DATA", personalInfoDataM);
        return true;
    }
