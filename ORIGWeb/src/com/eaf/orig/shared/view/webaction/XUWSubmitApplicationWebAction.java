 ...
 */
public class XUWSubmitApplicationWebAction extends WebActionHelper implements
        WebAction {
    Logger log = Logger.getLogger(XUWSubmitApplicationWebAction.class);
    /* (non-Javadoc)
    ...
    public Event toEvent() {
		...
		if(ORIGUtility.isEmptyString(applicationDataM.getXuwFirstId())){
			applicationDataM.setXuwFirstId(username);
			applicationDataM.setXuwStartDate( new Timestamp(System.currentTimeMillis()));
		}
		
		applicationDataM.setXuwLastId(username);
		applicationDataM.setXuwEndDate(new Timestamp(System.currentTimeMillis()));
		...
		ApplicationEvent event = new ApplicationEvent(ApplicationEvent.XUW_SUBMIT, applicationDataM, userM);
    ...
    public String getNextActionParameter() {
    	return "page=XUW_SUMMARY_SCREEN";
    }
