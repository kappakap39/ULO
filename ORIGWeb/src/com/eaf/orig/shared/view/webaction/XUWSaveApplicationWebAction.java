 ...
 */
public class XUWSaveApplicationWebAction extends WebActionHelper implements
        WebAction {
    ...
    public Event toEvent() {
		...
		ApplicationEvent event = new ApplicationEvent(ApplicationEvent.XUW_SAVE, applicationDataM, userM);
