 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AppraisalSummaryValueSubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(AppraisalSummaryValueSubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("AppraisalSummaryValueSubForm");
