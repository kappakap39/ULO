 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AppraisalDepreciationSubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(AppraisalDepreciationSubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("AppraisalDepreciationSubForm");
