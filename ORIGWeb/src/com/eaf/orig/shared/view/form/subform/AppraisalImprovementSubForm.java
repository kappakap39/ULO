 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AppraisalImprovementSubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(AppraisalImprovementSubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("AppraisalImprovementSubForm");
