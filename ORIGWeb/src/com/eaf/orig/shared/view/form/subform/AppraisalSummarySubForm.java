 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AppraisalSummarySubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(AppraisalSummarySubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("AppraisalSummarySubForm");
