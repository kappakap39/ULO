 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AppraisalIdentificationSubForm extends ORIGSubForm {
    Logger logger = Logger.getLogger(AppraisalIdentificationSubForm.class);
    ...
    public void setProperties(HttpServletRequest request, Object appForm) {
    	logger.debug("AppraisalIdentificationSubForm");
