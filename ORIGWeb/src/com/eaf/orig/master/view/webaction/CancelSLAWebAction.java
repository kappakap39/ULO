 ...
 */
public class CancelSLAWebAction extends WebActionHelper implements
		WebAction {

	static Logger logger = Logger.getLogger(CancelSLAWebAction.class);
	...
	public boolean preModelRequest() {
        try {
        	...
        	formHandler.setShwAddFrm("cancel");
