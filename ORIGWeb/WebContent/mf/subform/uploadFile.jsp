...
<script type="text/javascript" src="mf/subform/js/uploadFile.js"></script>
					...
					<div class="row form-horizontal">
						<div class="col-md-12">
							<div class="form-group">
								<%=HtmlUtil.getMandatoryLabel(request, "MF_FILE_NAM","col-sm-3 col-md-4 control-label")%>
								<div class="col-sm-9 col-md-8">
									<div id="UPLOAD_FILE_MANUAL">Browse</div>
								</div>
...
<%=HtmlUtil.hidden("MF_IMPORT_ID", IMPORT_ID)%>
<%=HtmlUtil.hidden("MF_DOWNLOAD_ID", DOWNLOAD_ID)%>


<!-- <div class="bootstrap-dialog type-warning fade size-normal in"tabindex="-1" role="dialog" aria-hidden="false" -->
<!-- 	id="block_screen_ui" style="display: none; width: 100%"> -->
