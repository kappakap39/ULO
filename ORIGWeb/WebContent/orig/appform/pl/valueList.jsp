...
<% 	
    Vector jobVect = VALUE_LIST.getResult();
%>

<%	
if(null != jobVect && jobVect.size() > 1){
	...
	int allItemCount = VALUE_LIST.getCount();
	int itemsPerPage = VALUE_LIST.getItemsPerPage();
	...
	int atPage = VALUE_LIST.getAtPage();
