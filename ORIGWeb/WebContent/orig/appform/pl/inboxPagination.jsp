...
if(!OrigUtil.isEmptyVector(jobVect)){
	...
	int allItemCount = ORIGInbox.getTotalJob();
	int itemsPerPage = ORIGInbox.getItemPerPage();
	...
	int atPage = ORIGInbox.getPageNo();
...
<%=HTMLRenderUtil.displayHiddenField(String.valueOf(ORIGInbox.getPageNo()),"atPage")%>
<%=HTMLRenderUtil.displayHiddenField(String.valueOf(ORIGInbox.getTotalJob()),"totalItem")%>
<%=HTMLRenderUtil.displayHiddenField(String.valueOf(ORIGInbox.isNextPage()),"isNextPage")%>
<%}%>
