...
<%
		...
		for(int i = 0; i < popMs.size(); i++){
			...
			System.out.println(">>>popTmp.getType()="+popTmp.getType());
			System.out.println(">>>popTmp.getTarget() ="+popTmp.getTarget());
			System.out.println(">>>popTmp.getTarget() ="+popTmp.getResult());
