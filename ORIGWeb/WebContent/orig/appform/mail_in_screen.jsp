									...
									<td align="center">
										<table width="50%" align=center cellpadding="0" cellspacing="1" border="0">
				                          ...
				                          <TR>
				                          	...
				                          	<TD class="inputCol" colspan="2" id="idNoText"></TD>
				                          </TR>
				                         <tr> 
				                           <!-- <td  align="left" class="textColS" width="40%">&nbsp;</td> --> 
				                            <td class="textColS" align="right" width="20%">
				                            	<%=ORIGDisplayFormatUtil.displayCheckBox("","drawDown","Y","onClick=\"javascript:createDrawdown()\" "+ "onMouseOver=\""+tooltipUtil.getTooltip(request,"app_draw_down")+"\" " ) %> 
				                            </td><td class="textColS" width="10%"><%=MessageResourceUtil.getTextDescription(request, "DRAW_DOWN") %>
				                            </td>
				                            <td class="textColS" width="6%"><input type="button" name="okBtn" value=" <%=MessageResourceUtil.getTextDescription(request, "OK") %> " class="button_text" onClick="javascript:gotoAppForm()">
				                           </td><td class="textColS" width="25%"> <input type="button" name="linkMultiApp" value="<%=MessageResourceUtil.getTextDescription(request, "MULTI_APPL") %>" class="button_text" onClick="javascript:linkAction()">
				                          	</td>
				                          </tr>
				                        </table>
									</td>
