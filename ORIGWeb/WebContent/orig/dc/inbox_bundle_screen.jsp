...
<%  
	org.apache.log4j.Logger log=org.apache.log4j.Logger.getLogger("orig/dc/inbox_screen.jsp");
...
%>
<script type="text/javascript" src="orig/js/inbox/pl/dc_bundle_cc.inbox.js"></script>
