...
<%  org.apache.log4j.Logger log=org.apache.log4j.Logger.getLogger("orig/dc/inbox_icdc_screen.jsp");  
    log.debug("DC Inbox Screen");	 
...
%>
<script type="text/javascript" src="orig/js/inbox/pl/dc_icdc.inbox.js"></script>
