...
<script type="text/javascript" src="orig/js/sup/rework.screen.js"></script>
<%  org.apache.log4j.Logger log=org.apache.log4j.Logger.getLogger("orig/sup/re_work_screen.jsp");
	...
	Vector vSaleType = origCache.loadCacheByActive("MainSaleType");
		...
		<div class="PanelSecond TextHeaderNormal">
			...
			<div class="PanelThird">
				...
				<legend>Search Criteria</legend>
					<table class="FormFrame">
                        ...
                        <tr height="25">
                            <td colspan="6" valign="top" align="center"><input type="button" id="button-search" class="button" value="Search" onClick="javascript:searchRework()" /></td>
                        </tr>
					</table>
				</fieldset>
			</div>
			<div class="PanelThird">
				...
				if((valueList!=null)&&(valueList.size()>=1)){%>
					<tr height="30">
	                	<td class="textL" nowrap="nowrap" colspan="10">Total Records Found : <%=VALUE_LIST.getCount() %></td>
	                </tr>
				<%} else {%>
					<tr height="30">
	                    <td class="textL" nowrap="nowrap" colspan="10">Total Records Found : 0</td>
	                </tr>
				<%}%>
                    <tr class="Header">
                    	<td width="10"><input type="checkbox" name="checkBoxAll" onclick="checkboxAll('checkBoxAll')" id="checkBoxAll"></td>
					...
					<tr class="Result-Obj <%=styleTr%>" id="<%=(String) elementList.elementAt(11)+"|"+(String) elementList.elementAt(2)%>">	
		                ...
		                <td><%=HTMLRenderUtil.displayHTML(HTMLRenderUtil.displayThFullName((String) elementList.elementAt(9), vUser)) %></td>
					</tr>
						<%}
                    } else {%>
                    ...
                    <tr height="40" valign="bottom">
                    	<td><input type="button" value="Re-work" name="rework" class="button" onclick="reWorkAction()"></td>
                    	<td colspan="9" align="right"><jsp:include page="../appform/pl/valueList.jsp" flush="true" /></td>
                    </tr>
				</table>
			</div>	
		</div>
