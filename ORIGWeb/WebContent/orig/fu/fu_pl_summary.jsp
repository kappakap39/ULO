			...
			<div class="PanelThird">
				<table class="FormFrame">
					...
					<tr height="25">
                        ...
                        <td width="25%" class="inputL"><%=HTMLRenderUtil.displayHTML(cacheUtil.GetUserNameByuserID(appM.getUpdateBy())) %></td>
                        <td width="25%" class="textR" align="right"><%=PLMessageResourceUtil.getTextDescription(request, "SUM_LAST_UPDATE_DATE") %> :</td>
                        <td width="30%" class="inputL"><%=HTMLRenderUtil.displayHTML(DataFormatUtility.dateTimetoStringForThai(appM.getUpdateDate())) %></td>
                    </tr>
					<tr height="25">
						<td width="20%" class="textR" align="right"><%=PLMessageResourceUtil.getTextDescription(request, "APPLICATION_STATUS") %> :</td>
                        <td width="25%" class="inputL"><%=HTMLRenderUtil.DisplayReplaceLineWithNull(wfTool.GetMessageAppStatus(request, appM.getApplicationStatus())) %></td>
					...
					<tr height="25">
                        ...
                        <td width="25%" class="inputL"><%=HTMLRenderUtil.DisplayReplaceLineWithNull(HTMLRenderUtil.DisplayReasonDesc(appM.getReasonVect(), appM)) %></td>
