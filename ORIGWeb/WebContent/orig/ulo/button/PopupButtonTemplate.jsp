...
<script type="text/javascript" src="orig/ulo/button/js/PopupButtonTemplate.js"></script>
<% 
...
<section class='work_tools_area' style="width: auto; margin: 0">
	<%=HtmlUtil.button("SAVE_POPUP_BTN", "SAVE_POPUP_BTN", "", "btn_save","tooltip title='Save'",formEffect) %>
