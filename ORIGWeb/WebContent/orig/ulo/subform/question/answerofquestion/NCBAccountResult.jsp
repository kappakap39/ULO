...
<script type="text/javascript" src="orig/ulo/subform/question/answerofquestion/js/NCBAccountResult.js"></script>
<jsp:useBean id="ModuleForm" scope="session" class="com.eaf.orig.ulo.formcontrol.view.form.ModuleFormHandler"/>
<jsp:useBean id="ORIGUser" scope="session" class="com.eaf.orig.profile.model.UserDetailM"/>
<% 
	Logger logger = Logger.getLogger(this.getClass());	
	String NCB_CREDIT_TYPE_CRD = SystemConstant.getConstant("NCB_CREDIT_TYPE_CRD");
							...
							int seq = 0;
								for(NcbAccountDataM ncbAccount:accountList){									
										...
										<tr>
											...
											<td><%=FormatUtil.displayCurrency(ncbAccount.getCreditlimOrloanamt(),false) %></td>
