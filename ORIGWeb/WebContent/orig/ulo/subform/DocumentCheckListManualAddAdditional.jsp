...
<script type="text/javascript" src="orig/ulo/subform/js/DocumentCheckListManualAddAdditional.js"></script>
<%
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<%=LabelUtil.getText(request, "ADDITIONAL_DOCUMENT")%>
			</div>
			<table class="table table-documentchecklist">
				<tbody>
<% 
					int seqInt = 0;
					ArrayList<DocumentCheckListDataM> docLists = applicationGroup.getDocumentCheckListManualAdditionals();
...
%>
							<tr class="doctype">
								<td>
									<%=HtmlUtil.button("BTN_DEL_DOC_MAN_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL, docCheckListId, "", mode, "btnsmall_delete", "", request) %>
								</td>
								<td width="40%">
									<div class="form-group">
										<%=HtmlUtil.dropdown("DOC_LIST_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL, seq, "DOC_LIST_ADDITIONAL", docCode, "", "", "", "", "", "", request)%>
									</div>
								</td>
								<td>
									<div>
...
%>
											<div class="col-sm-12">
												<div class="form-group">
													<%=HtmlUtil.checkBoxInline("FOLLOWED_DOC_REASON_SELECT_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL, CODE + "_" + seq, reasonM.getDocReason(), CODE, displayMode, "", VALUE, "text-left", request) %>			
												</div>
											</div>
									...
									<div class="row form-horizontal">
										<div class="col-md-12">
											<div class="form-group">
												...
												<%=HtmlUtil.textarea("FOLLOWED_REMARK_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL,seq, docList.getRemark(), "5", "100", "200", displayMode, HtmlUtil.elementTagId("FOLLOWED_REMARK"), "col-sm-10 col-md-9", request) %>
											</div>
										</div>
									</div>
								</td>
...
%>						
						<tr class="doctype">
							<td colspan="3"></td>
							<td>
								<%=HtmlUtil.button("BTN_ADD_DOC_MAN_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL, "", "", mode, "btnsmall_add", "", request) %>
							</td>
						</tr>
<%					
					} else {
						...
						<tr class="doctype">
							<td>
								<div style="float: right;">
									<%=HtmlUtil.button("BTN_ADD_DOC_MAN_INIT_" + DOC_CHECKLIST_MANUAL_FLAG_ADDITIONAL, "", "", mode, "btnsmall_add", "", request) %>
								</div>
							</td>
						</tr>
<%
