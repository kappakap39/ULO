...
<script type="text/javascript" src="orig/ulo/subform/js/PersonalInfoSubForm.js?v=1"></script>
<%
	String subformId = "NORMAL_PERSONAL_INFO_SUBFORM_1";
	...
	String TAG_ID_TH_MID_NAME = " tabindex='-1' placeholder='"+LabelUtil.getText(request, "SHOW_TH_MID_NAME")+"'";
	String TAG_ID_EN_MID_NAME = " tabindex='-1' placeholder='"+LabelUtil.getText(request, "SHOW_TH_MID_NAME")+"'";
