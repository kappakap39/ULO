...
<script type="text/javascript" src="orig/ulo/subform/summary/increase/js/SummaryIncreaseSubForm.js"></script>
<%
 Logger logger = Logger.getLogger(this.getClass());	
 ApplicationGroupDataM  applicationGroup =  ORIGForm.getObjectForm();
 String[] elementSubForm = SystemConstant.getArrayConstant("SUMMARY_INCREASE_ELEMENT");
...
<%	for(int i=0;i<elementSubForm.length;i++){
		ElementInf element = ImplementControl.getElement(MConstant.IMPLEMENT_TYPE.SUMMARY_INCREASE,elementSubForm[i]);%>
