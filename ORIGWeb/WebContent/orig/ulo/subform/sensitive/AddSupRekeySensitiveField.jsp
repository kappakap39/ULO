...
<script type="text/javascript" src="orig/ulo/subform/sensitive/js/AddSupRekeySensitiveField.js"></script>
...
<%
	...
	ArrayList<ElementInf>   sensitiveFields = ImplementControl.getElements("COMPARE_SENSITIVE",SystemConstant.getConstant("COMPARE_SENSITIVE_"+roleId+"_ADD_SUP").split(","));		
%>
