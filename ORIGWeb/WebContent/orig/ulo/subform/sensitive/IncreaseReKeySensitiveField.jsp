...
<script type="text/javascript" src="orig/ulo/subform/sensitive/js/IncreaseReKeySensitiveField.js"></script>
...
<%
	...
	ArrayList<ElementInf>   sensitiveFields = ImplementControl.getElements("COMPARE_SENSITIVE",SystemConstant.getConstant("COMPARE_SENSITIVE_"+roleId+"_INCREASE").split(","));
