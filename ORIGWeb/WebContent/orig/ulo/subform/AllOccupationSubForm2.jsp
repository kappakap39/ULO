...
<div class="row form-horizontal">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<%=HtmlUtil.hidden("PROFESSION_CODE", personalInfo.getProfession()) %>
	...
	<!-- <div class="col-sm-6">
		<div class="form-group">
			...
			personalInfo.getBusinessNature(), "",FIELD_ID_BUSINESS_NATURE,"ALL_ALL_ALL", "", "col-sm-8 col-md-7", formUtil)%>
		</div>
	</div> -->
	<% if(isKPL){ %>
		<div class="clearfix"></div>
				...
				<div class="row">
					<div class="col-xs-12">
						<%=HtmlUtil.dropdown("PREV_COMPANY_TITLE", "PREV_COMPANY_TITLE_"+personalElementId, "PREV_COMPANY_TITLE", "", 
							personalInfo.getPrevCompanyTitle(), "dropdown-textbox-1",FIELD_ID_COMPANY_TITLE,"ALL_ALL_ALL","","col-xs-2 col-xs-padding", formUtil)%>
						<%=HtmlUtil.autoComplete("PREV_COMPANY", "", "PREV_COMPANY_"+personalElementId, "", "COMPANY_NAME_LISTBOX", 
							personalInfo.getPrevCompany(), "", "","ALL_ALL_ALL","","col-xs-5 col-xs-padding", "100", formUtil)%>
					</div>
				</div>
			</div>
		</div>
