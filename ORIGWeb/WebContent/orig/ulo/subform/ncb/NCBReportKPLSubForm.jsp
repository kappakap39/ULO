...
<%
	...
	if(!Util.empty(ncbAccR31List=ncbInfoDataM.filterNCBAccountByRule(ruleId31,VER_RESULT_FAIL))){
	  	 ncbAccR31List = ncbInfoDataM.filterNCBAccountByRule(ruleId31,VER_RESULT_FAIL);
	  	 break;
	  	 }
	   }
	}
	...
	<div class="row form-horizontal">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="col-sm-2">		
					<%=HtmlUtil.radioInline("NCB_PASS", ncbInfoDataM.getTrackingCode()+"_"+PRODUCT_K_PERSONAL_LOAN, NCB_RESULT,  MConstant.FLAG.YES, HtmlUtil.VIEW, HtmlUtil.elementTagId("NCB_PASS"), "NCB_PASS", request) %>		
				</div>
				<div class="col-sm-3S">
					<%=HtmlUtil.radioInline("NCB_NOT_PASS", ncbInfoDataM.getTrackingCode()+"_"+PRODUCT_K_PERSONAL_LOAN, NCB_RESULT,  MConstant.FLAG.NO, HtmlUtil.VIEW, HtmlUtil.elementTagId("NCB_NOT_PASS"), "NCB_NOT_PASS", request) %>		
				</div>
			</div>
		</div>
		<!-- 		or 20 fail or all pass -->
		<div class="col-sm-12 ">
			...
			<table class="table table-bordered table-hover">
				...
				for(NcbAccountDataM  ncbAcountR31 :ncbAccR31List){
					...
					<tr>
						...
						<td><%=FormatUtil.displayNCBPaymentHistory(FormatUtil.displayText(ncbAcountR31.getPmtHist1())+FormatUtil.displayText(ncbAcountR31.getPmtHist2()),INTERVAL, GROUP)%></td>		
					</tr>
					<%} } %>	
				</tbody>
			</table>
