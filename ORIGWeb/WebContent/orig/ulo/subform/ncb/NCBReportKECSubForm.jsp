		...
		<div class="row form-horizontal">
			<div class="col-sm-12">
				<div class="form-group">
					<div class="col-sm-2">		
						<%=HtmlUtil.radioInline("NCB_PASS", ncbInfoDataM.getTrackingCode()+"_"+PRODUCT_K_EXPRESS_CASH, NCB_RESULT,  MConstant.FLAG.YES, HtmlUtil.VIEW, HtmlUtil.elementTagId("NCB_PASS"), "NCB_PASS", request) %>		
					</div>
					<div class="col-sm-3S">
						<%=HtmlUtil.radioInline("NCB_NOT_PASS", ncbInfoDataM.getTrackingCode()+"_"+PRODUCT_K_EXPRESS_CASH, NCB_RESULT,  MConstant.FLAG.NO, HtmlUtil.VIEW, HtmlUtil.elementTagId("NCB_NOT_PASS"), "NCB_NOT_PASS", request) %>		
					</div>
				</div>
			</div>
