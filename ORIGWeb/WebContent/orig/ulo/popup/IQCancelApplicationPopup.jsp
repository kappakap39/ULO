...
<script type="text/javascript" src="orig/ulo/popup/js/IQCancelApplicationPopup.js"></script>
<%
	Logger logger = Logger.getLogger(this.getClass());
	logger.debug("IQ Cancel Application Popup ..................");	
			...
			<div class="col-md-12">
				<div class="col-md-8">
					<div class="form-group">
						<%=HtmlUtil.getSubFormLabel(request,subFormId,"REASON_CODE","REASON", "col-sm-4 control-label")%>
						<%=HtmlUtil.dropdown("REASON_CODE","","55","","","55","","","","col-sm-8",request)%>
					</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">				
			...
			<div class="col-md-12">
				<div class="col-md-8">
					<div class="form-group">
						...
						<%=HtmlUtil.textarea("REMARK", "", "", "", "20", "200", "", null, "col-sm-8", request) %>
					</div>
				</div>
			</div>
		</div>
