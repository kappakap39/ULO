...
function POPUP_OTH_FIXED_ACCT_FORMAfterLoadPopupFinishActionJS(){
	try{
...
function POPUP_OTH_FIXED_ACCT_FORMAfterSaveActionJS() {
	try{
...
$(document).ready(function () {
	$("#OthFixedAcct").on("click", ".BtnRemove", deleteIncomeCategoryPopup);
});
