...
<%
	...
	ApplicationDataM applicationItem = applicationGroup.getApplicationProduct(PRODUCT_K_PERSONAL_LOAN);
...
// 	String TAG_SMART_DATA_PERSONAL = FormatUtil.getSmartDataEntryId(PERSONAL_TYPE, PERSONAL_SEQ);
	...
	String formId = "PRODUCT_FORM_KPL";
		...
		<div class="row form-horizontal">
			<div class="col-sm-6">
				<div class="form-group">
					...
					<%=HtmlUtil.calendar("SP_SIGN_OFF_DATE", PRODUCT_K_PERSONAL_LOAN,"SP_SIGN_OFF_DATE_"+productElementId, "SP_SIGN_OFF_DATE", 
			...
			<div class="col-sm-6">
				<div class="form-group">
					...
					<%=HtmlUtil.textBox("SP_SIGN_OFF_AUTHORIZED_BY",PRODUCT_K_PERSONAL_LOAN,"SP_SIGN_OFF_AUTHORIZED_BY_"+productElementId,"SP_SIGN_OFF_AUTHORIZED_BY",
