...
<%
	String subformId = "SUP_AMWAY_POPUP";
...
<%-- 							personalInfo., "","","ALL_ALL_ALL", "", "col-sm-8 col-md-7", applicationItem, formUtil)%> --%>
...
<%-- 							card.getCardLevel(), "", FIELD_ID_CARD_LEVEL,"ALL_ALL_ALL", "", "col-sm-8 col-md-7", applicationItem, formUtil)%> --%>
					</div>
				</div>
...
<%-- 					<%=HtmlUtil.currencyBox("PERCENT_LIMIT", "",PRODUCT_CRADIT_CARD, "PERCENT_LIMIT_"+productElementId,new BigDecimal("0"), "", false, "", "", "col-sm-8 col-md-7", applicationItem, formUtil) %> --%>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="form-group">
						<%=HtmlUtil.getSubFormLabel(request,applicationItem,subformId,"AMWAY_NO","AMWAY_NO","col-sm-4 col-md-5 control-label")%>
						<%=HtmlUtil.textBox("AMWAY_NO",PRODUCT_CRADIT_CARD,"AMWAY_NO_"+productElementId,"AMWAY_NO",
