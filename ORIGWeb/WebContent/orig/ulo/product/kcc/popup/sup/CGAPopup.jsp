...
<%
	String subformId = "SUP_CGA_POPUP";
...
<%-- 						CardLevel, "",FIELD_ID_CARD_LEVEL,"ALL_ALL_ALL", "", "col-sm-8 col-md-7",applicationItem, formUtil)%> --%>
			...
			<div class="col-sm-6">
				<div class="form-group">
					<%=HtmlUtil.getSubFormLabel(request,applicationItem,subformId,"CHANNEL_NO","CHANNEL_NO", "col-sm-3 col-md-4 control-label")%>
					<div class="col-sm-8 col-md-7">
						<div class="row">
							<div class="col-xs-12">
<%-- 								<%=HtmlUtil.textBox("CHANNEL_NO",PRODUCT_CRADIT_CARD,"CHANNEL_NO","CHANNEL_NO", --%>
...
<%-- 								<%=HtmlUtil.textBox("REFERRAL_CARD_NO",PRODUCT_CRADIT_CARD,"REFERRAL_CARD_NO_"+productElementId,"CHANNEL_NO", --%>
