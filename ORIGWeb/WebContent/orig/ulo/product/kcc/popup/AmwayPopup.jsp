			...
			<div class="row form-horizontal">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<%=HtmlUtil.span("", FormatUtil.display(CARD_TYPE_DESC), "nopadding col-md-7") %>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<%=HtmlUtil.getSubFormLabel(request,applicationItem,subformId,"CARD_LEVEL","CARD_LEVEL","col-sm-4 col-md-5 control-label")%>
				...
				<div class="col-sm-12">
					<div class="form-group">
						<%=HtmlUtil.getSubFormLabel(request, applicationItem,subformId,"AMWAY_NO","AMWAY_NO","col-sm-6 control-label")%>
						<%=HtmlUtil.textBox("AMWAY_NO", PRODUCT_CRADIT_CARD,"AMWAY_NO_"+productElementId,"AMWAY_NO",
							card.getMembershipNo(),"","50","","col-sm-6", applicationItem, formUtil)%>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
