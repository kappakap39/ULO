...
<%
	...
	String subformId = "KCC_ADDITIONAL_SERVICE_SUBFORM1";
	...
	logger.debug("EMAIL_FLAG :"+EMAIL_FLAG);
	...
	String EmailFlag = ListBoxControl.getName(FIELD_ID_SPECIAL_ADDITIONAL_SERVICE, SPECIAL_ADDITIONAL_SERVICE_EMAIL, "REMARK");
	
	FormUtil formUtil = new FormUtil("PRODUCT_FORM_CC",subformId,request);	
%>
	<div class="panel panel-default" id ="ADDITIONAL_SERVICE_WISDOM_INFINITE_SUBFORM">
		 <div class="panel-body">
			<div class="row form-horizontal">
				...
				<div class="col-sm-12">
					<div class="form-group">
						<%=HtmlUtil.checkBoxInline("SERVICE_TYPE_EMAIL_FLAG", PRODUCT_CRADIT_CARD ,"SERVICE_TYPE_EMAIL_FLAG_"+productElementId, "SERVICE_TYPE_EMAIL_FLAG", 
							EMAIL_FLAG, "", MConstant.FLAG.YES, "", EmailFlag, "col-xs-12 control-label", formUtil) %>
					</div>
				</div>
			</div>
		</div>
