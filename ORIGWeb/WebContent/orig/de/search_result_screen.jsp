					...
					<%
						...
						if(valueList != null && valueList.size() > 1){
							...
							for(int i=1;i<valueList.size();i++){
								...
								//sDate = ((String)elementList.elementAt(2)).substring(0,9);
								//sTime = ((String)elementList.elementAt(2)).substring(10);
								//sDate = ORIGUtility.displayEngToThaiDate(ORIGDisplayFormatUtil.parseDate(ORIGDisplayFormatUtil.StringToDate(sDate,"mm/dd/yyyy")));
					%>
						<tr><td align="center" class="gumaygrey2">
							<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
								<tr onmouseover="this.style.cursor='hand' ;this.style.background='#D7D6D7'" onmouseout=" this.style.background='#FFFFFF'" onclick="javascritp:gotoAppForm('<%=elementList.elementAt(12) %>', '<%=elementList.elementAt(13) %>', '<%=elementList.elementAt(14) %>')">
									<td class="jobopening2" width="70" align="center"><%=ORIGDisplayFormatUtil.displayHTML((String) elementList.elementAt(18)) %></td>
...
<form action="../export/excel/general_enquiry.jsp" target="_blank">
	<input type=submit value='Export to Excel' class="button_text" />
</form>
<% } %>
