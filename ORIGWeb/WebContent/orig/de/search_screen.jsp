...
<%
	...
	String dealer = cacheUtil.getORIGCacheDisplayNameFormDB(SEARCH_DE_DATAM.getDealerCode(), OrigConstant.CacheName.CACHE_NAME_DEALER);
                        ...
                        <tr class="sidebar10"> <td align="center">
							<table width="100%" align=center cellpadding="0" cellspacing="1" border="0">
			 					<tr>
			 						...
			 						<td class="inputCol" width="25%"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getApplicationNo(), displayMode, "", "application_no", "textbox", "", "")%></td>
			 					</tr>
			 					<tr>
								 ...
								 <tr>
								 	...
								 	<td class="inputCol"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getRegisterNo(), displayMode, "", "register_no", "textbox", "", "")%></td>			 				 				 	
								 	<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "DEALER_CODE_NAME") %> :</td>
								 	<td class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction(SEARCH_DE_DATAM.getDealerCode(),displayMode,"5","dealer_code","30","dealer_desc","textbox","","50","...","button_text","LoadDealer",ORIGDisplayFormatUtil.displayHTML(dealer),"Dealer") %></td>
								 </tr>			 
								 <tr>
									...
									<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "CHANNEL") %> :</td>
								 	<td class="inputCol"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction_ORIG(channelVect,SEARCH_DE_DATAM.getChannel(),"channel",displayMode,"") %></td>
								 </tr>
								 <tr>			 	
								 	<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "PRIORITY") %> :</td>
								 	<td class="inputCol"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction(priorityVect,SEARCH_DE_DATAM.getPriority(),"priority",displayMode,"") %></td>		 				 				 	
								...
								<!-- Wiroon 20100315 -->
								 <tr>
								 	...
								 	<td class="inputCol" width="25%"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getCo_citizenID(), displayMode, "", "co_citizen_id", "textbox", "", "")%></td>
								 ...
								 <tr>
								 	...
								 	<td class="inputCol" width="25%"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getCo_customerFName(), displayMode, "", "co_fname", "textbox", "", "")%></td>
								 	<td class="textColS" width="25%"><%=MessageResourceUtil.getTextDescription(request, "CO_LNAME") %> :</td>
								 	<td class="inputCol" width="25%"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getCo_customerLName(), displayMode, "", "co_lname", "textbox", "", "")%></td>
								 </tr>
								 <!-- 20100315 -->
								 <tr>
									<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "GROUP_ID") %> :</td>
									<td class="inputCol"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(SEARCH_DE_DATAM.getGroupID(), displayMode, "", "group_id", "textbox", "", "")%></td>
...
<table id="resultTable" height="100%" width="100%">
	<tr>
		<td><iframe src="orig/de/search_result_screen.jsp" width="100%" height="100%" name="MainAppFrame" allowTransparency="true" style="background-color: #FFFFFF" frameborder="0"></iframe></td>
	</tr>
</table>
...
function validate(){
	...
	if( (groupID=="") && (citizen_id=="") && (application_no=="") && (company_name=="") && (lastname=="") && (register_no=="") && (dealer_code=="") && (customer_type=="") && (channel=="") && (priority=="") && (co_citizen_id=="") && (co_fname=="") && (co_lname=="")){
