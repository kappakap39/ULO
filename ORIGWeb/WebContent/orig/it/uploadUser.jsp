...
<script type="text/javascript" src="orig/it/js/uploadFileUser.js"></script>
					...
					<div class="row form-horizontal">
						<div class="col-md-12">
							<div class="form-group">
								<%=HtmlUtil.getMandatoryLabel(request, "UPLOAD_USER","col-sm-3 col-md-4 control-label")%>
								<div class="col-sm-9 col-md-8">
									<div id="UPLOAD_USER">Browse</div>
								</div>
