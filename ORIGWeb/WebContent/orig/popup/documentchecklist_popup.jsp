					...
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
			 			<tr> <td  height="10">
			 				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          	<tr>
	                          	<td class="text-header-detail"><%=MessageResourceUtil.getTextDescription(request, "DOCUMENT_LIST") %> </td>
	                            <td width="330">
	                            	<table width="50" border="0" align="right" cellpadding="2" cellspacing="0">
	                              		<tr height="30"><td>
											<input class="button" type="button" name="add" value="<%= MessageResourceUtil.getTextDescription(request, "SAVE") %>" onclick="savedocumentlist()" <%=disabledBtn %>></td>
									...
									<table class="gumayframe3" cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
										<tr><td class="TableHeader">
											<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
												<tr>
									                <td class="Bigtodotext3" width="12%" align="center" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "RECEIVE_DOCUMENT") %></td>
									                <td class="Bigtodotext3" width="10%" align="center" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "WAIVE") %></td>
									                <td class="Bigtodotext3" width="14%" align="center" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "NOT_RECEIVE_DOCUMENT") %></td>
									                <td class="Bigtodotext3" width="25%" align="center" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "DESCRIPTION") %></td>
									                <td class="Bigtodotext3" width="12%" align="left" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "REQUIRE") %></td>
									                <td class="Bigtodotext3" width="27%" align="center" valign="middle"><%=MessageResourceUtil.getTextDescription(request, "REMARK") %></td>
									            </tr>
											</table> 
										</td></tr>
						               <% 
						              if(documentVect!=null){
						             	...
						             	String notReceive = "";
							              ...
							              System.out.println("documentlistM.getDocTypeId() = "+documentlistM.getDocTypeId());
							             	System.out.println("document required >>"+documentlistM.getRequire());
              							...
              							<tr><td align="center" class="gumaygrey2">
											<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
												<tr> 
							                        <td class="jobopening2" align="center" width="14%">
							                        ...
							                        <td class="jobopening2" align="center" width="10%"> 
							                        ...
							                        <td class="jobopening2" align="center" width="27%"> 
							                        	<%=documentlistM.getDocTypeDesc()%></td>
							                        <td class="jobopening2" align="center" width="12%"> 
							                        ...
							                        <td class="jobopening2" align="center" width="25%"> 
							                        	<%=ORIGDisplayFormatUtil.displayInputTagScriptAction(remark,displayMode,"","remark","","onBlur=\"javascripe:change2Uppercase(this)\" ","300") %></td>						                        
						                      	</tr>
						                    </table>
						                 </td></tr> 
						                      <% } 
