...
<script type="text/javascript" src="orig/js/popup/pl/master-popup-fieldid-desc.js"></script>
<% 
						...
						%>															
								<tr class="Result-Obj tr-master-popup <%=styleTr%>" id="<%=HTMLRenderUtil.displayHTML(elementList.elementAt(1))%>">
									...
									<td width="80%" class="TextTDLeft">
										...
										<%=HTMLRenderUtil.displayHiddenField((String)elementList.elementAt(2) ,"choiceno_"+HTMLRenderUtil.displayHTML(elementList.elementAt(1)))%>	
									</td>
								</tr>
						<%}%>
					<%}else{%>
