...
%>
<script language="JavaScript" src="orig/js/inbox/pl/df.approve.inbox.js"></script>
<div class="nav-inbox">
			...
			<div class="PanelThird">
				<table class="FormFrame">
					<tr>
						...
						<%=PLMessageResourceUtil.getTextDescription(request, "JOB_STATUS")%></td>
