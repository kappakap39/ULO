...
<%
	...
	String cmrDecision = applicationDataM.getAppDecision();
	if(ORIGUtility.isEmptyString(cmrDecision)){
		cmrDecision = "Submitted";
	}
%>
		    	...
		    	<tr><td class="sidebar9">
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
			 			<tr> <td  height="10">
                            ...
                            <tr>
                            	<td class="Bigtodotext3" colspan="2" align="center">This application has been <%=cmrDecision%></td>
                            </tr>
                            </table>
                        </td></tr>
							...
							<table width="100%" align=center cellpadding="0" cellspacing="1" border="0">
								...
								<tr>
									...
									<td class="inputCol"><%= cacheUtil.getORIGMasterDisplayNameDataM("Title", personalInfoDataM.getThaiTitleName()) %>
										<%= personalInfoDataM.getThaiFirstName() %>
										<%= personalInfoDataM.getThaiLastName() %>
									</td>
