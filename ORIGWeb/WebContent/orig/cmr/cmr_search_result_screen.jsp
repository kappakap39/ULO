						...
						<tr><td class="TableHeader">
							<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
								<tr>
									...
									<td class="Bigtodotext3" width="100" nowrap><%=MessageResourceUtil.getTextDescription(request, "APPLICATION_NO") %></td>
					...
					<%
						...
						if(valueList != null && valueList.size() > 1){
							...
							for(int i=1;i<valueList.size();i++){
								...
								srcofcus = cacheUtil.getORIGMasterDisplayNameDataM("ParameterDetailCode", (String) elementList.elementAt(11));
						...
						<tr><td align="center" class="gumaygrey2">
							<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
								...
								onclick="javascritp:gotoAppForm('<%=elementList.elementAt(12) %>', '<%=elementList.elementAt(13) %>', '<%=elementList.elementAt(14) %>')">
									<td class="jobopening2" align="center" width="70"><%=ORIGDisplayFormatUtil.displayHTML(utility.getPriorityDescription((String) elementList.elementAt(1))) %></td>
									<td class="jobopening2" align="center" width="160"><%=ORIGDisplayFormatUtil.stringDateTimeValueListForThai((String) elementList.elementAt(2)) %></td>
									<td class="jobopening2" align="center" width="100"><%=ORIGDisplayFormatUtil.displayHTML(elementList.elementAt(3)) %></td>
									...
									<td class="jobopening2" align="center" width="160"><%=ORIGDisplayFormatUtil.displayHTML(elementList.elementAt(6)) %></td>
									...
									<td class="jobopening2" align="center" width="120"><%=ORIGDisplayFormatUtil.displayHTML(utility.getPersonalTypeDesc((String) elementList.elementAt(16))) %></td>
									<td class="jobopening2" width="140">&nbsp;<%=ORIGDisplayFormatUtil.displayHTML(elementList.elementAt(13)) %></td>
									<td class="jobopening2" align="center" width="60"><%=ORIGDisplayFormatUtil.displayHTML(ORIGUtility.getRoleByJobState((String) elementList.elementAt(14))) %></td>
									<%if( OrigConstant.SEARCH_TYPE_ENQUIRY.equals(searchType)){ %>
									<td class="jobopening2" align="center" width="70"><%=ORIGDisplayFormatUtil.displayHTML( (String) elementList.elementAt(18)) %></td>
									<%} %>
								</tr>
							</table> 
						</td></tr>
