...
<%  org.apache.log4j.Logger log=org.apache.log4j.Logger.getLogger("orig/ca/inbox_bundle_cc_screen.jsp");
...
%>
<script type="text/javascript" src="orig/js/inbox/pl/ca_bundle_cc.inbox.js"></script>
