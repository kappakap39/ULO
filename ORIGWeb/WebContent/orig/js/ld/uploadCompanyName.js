...
$(document).ready( function() {
	$("#DOWNLOAD_EXCEL").hide();
    uploadObj = $("#UPLOAD_COMPANYNAME_FILENAME").uploadFile({
		url:"UploadServlet",
		multiple:false,
		autoSubmit:false,
		fileName:"IMPORT_FILE",
		formData: {"IMPORT_ID":"UPLOAD_COMPANY_NAME"},
...
function downloadExcel(){
	window.open("/ORIGWeb/DownloadServlet?DOWNLOAD_ID=DOWNLOAD_EXCEL&FILE_NAME=UploadCompanyNameErrorList.xls");
}

function UPLOAD_FORECAST_CANCEL_BUTTONActionJS(){
	location.reload();
}