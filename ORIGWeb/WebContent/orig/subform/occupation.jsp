...
<% 
   ...
   Vector qualificationVect = cacheUtil.getNaosCacheDataMs("AL_ALL_ALL",2);
	...
	Vector businessTypeVect = utility.loadCacheByNameAndCheckStatus("BusinessType", personalInfoDataM.getBusinessType());
...
<table cellpadding="" cellspacing="1" width="100%">
	<tr>
		<td class="textColS" width="20%"><%=MessageResourceUtil.getTextDescription(request, "OCCUPATION") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","occupation")%></Font> :</td>
		<td class="inputCol" width="25%"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction_ORIG(occupationVect,personalInfoDataM.getOccupation(),"occupation",displayMode,"onChange=\"javascript:parseOccupationToPosition(this.value,'PositionId','position','" + positionSelect + "'); \" style=\"width:80%;\" ") %></td>
		<td class="textColS" width="20%"><%=MessageResourceUtil.getTextDescription(request, "BUS_TYPE") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","bus_type")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "BUS_SIZE") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","bus_size")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "COMPANY") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","company")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "DEPARTMENT") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","department")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "POSITION") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","position")%></Font> :</td>
		<td class="inputCol" id="PositionId"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction_ORIG_WithCheckStatus(positionVect,personalInfoDataM.getPosition(),"position",displayMode," style=\"width:80%;\"  ") %></td>
	</tr>
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "SALARY") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","salary")%></Font> :</td>
		<td class="inputCol"><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(ORIGDisplayFormatUtil.displayCommaNumber(personalInfoDataM.getSalary()),displayMode,"","salary","textboxCurrency","onblur=\"javascript:checkMinDecimalValue(this);chcekMaxDecimalValue(this);addComma(this);addDecimalFormat(this);\" onKeyPress=\"isNumberOnKeyPress(this)\" onkeyup=\"isNumberOnkeyUp(this)\" onfocus=\"removeCommaField(this)\" style=\"width:80%;\" ","16") %></td>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "OTHER_INCOME") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","other_income")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "POSITION_DESC") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","position_desc")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "SOURCE_OTHER_INCOME") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","source_other_income")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "QUALIFICATION") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","qualification")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "HOUSE_REGIS_STATUS") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","house_regis_status")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "BUILDING_CONDITION") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","building_condition")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "PREVIOUS_RECORD") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","pre_record")%></Font> :</td>
	...
	<tr>
		<td class="textColS" width="17%"><%=MessageResourceUtil.getTextDescription(request, "ASSET_AMT") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","asset_amount")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "LOCATION") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","location")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "CHEQUE_RETURNED") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","cheque_return")%></Font> :</td>
		...
		<td class="textColS" width="15%"><%=MessageResourceUtil.getTextDescription(request, "DEBT_AMT") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","debt_amount")%></Font> :</td>
	...
	<tr>
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "LAND_OWNERSHIP") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","land_ownership")%></Font> :</td>
		...
		<td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "NUMBER_OF_EMPLOYEE") %><Font color="#ff0000"><%=ORIGDisplayFormatUtil.getMandatory_ORIG(personalInfoDataM.getCustomerType(),ORIGUser.getRoles(),"OCCUPATION_SUBFORM","no_of_employee")%></Font> :</td>
