...
<%
	...
	Vector regisStatusVect = cacheUtil.getCurrentAddresType(); //cacheUtil.getNaosCacheDataMs("AL_ALL_ALL",3);
...
<table cellpadding="" cellspacing="1" width="100%">
	...
	<tr>
		...
		<td class="inputCol" >
			<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
				<tr><td><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(utility.intToString(preScoreDataM.getTotalWorkYear()),cmrDisplayMode,"5","pre_score_year","textbox"," onKeyPress=\"keyPressInteger();\" onblur=\"javascript:returnZero(this);checkCMRworingDate('birth_date','pre_score_year','pre_score_month',this);\" style='width:80%;'","2") %>
				</td><td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "YEAR") %>
		       	</td><td><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(utility.intToString(preScoreDataM.getTotalWorkMonth()),cmrDisplayMode,"5","pre_score_month","textbox"," onKeyPress=\"keyPressInteger();\" onblur=\"javascript:checkMonth('pre_score_month');returnZero(this);checkCMRworingDate('birth_date','pre_score_year','pre_score_month',this);returnZero(this);\" style='width:80%;'","2") %>
	...
	<tr>
		...
		<td class="inputCol" >
			<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
				<tr><td><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(ORIGDisplayFormatUtil.displayInteger(preScoreDataM.getTimeInCurrentAddressYear()),cmrDisplayMode,"5",
				"pre_score_time_current_address_year","textbox","onKeyPress=\"keyPressInteger(this.value);\" onblur=\"javascript:addCommas('pre_score_time_current_address_year');checkCMRAddressReside('birth_date','pre_score_time_current_address_year','pre_score_time_current_address_month',this);returnZero(this);\" style='width:80%;'","2") %>
				</td><td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "YEAR") %>
		   		</td><td><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(utility.intToString(preScoreDataM.getTimeInCurrentAddressMonth()),cmrDisplayMode,"5",
			   "pre_score_time_current_address_month","textbox"," onKeyPress=\"keyPressInteger(this.value);\" onBlur=\"javascript:checkMonth('pre_score_time_current_address_month');checkCMRAddressReside('birth_date','pre_score_time_current_address_year','pre_score_time_current_address_month',this);returnZero(this);\" style='width:80%;'","2") %>
			   </td><td class="textColS"><%=MessageResourceUtil.getTextDescription(request, "MONTH") %></td>
			</tr> 
			</table>
		</td>
	...
	<tr>
		...
		<td class="inputCol" ><%
		//=ORIGDisplayFormatUtil.displayInputTagScriptAction(ORIGDisplayFormatUtil.displayCommaNumber(preScoreDataM.getCarPrice()),cmrDisplayMode,"","pre_score_car_price","textboxCurrency","onblur=\"javascript:addComma(this);addDecimalFormat(this);calFinanceAmt();\" onKeyPress=\"isNumberOnKeyPress(this)\" onkeyup=\"isNumberOnkeyUp(this)\" onfocus=\"removeCommaField(this)\" "+ "onMouseOver=\""+tooltipUtil.getTooltip(request,"prescore_car_vat")+"\" ","16") %></td>
	</tr>
	<tr>
		...
		<td class="inputCol" ><%=ORIGDisplayFormatUtil.displayInputTagScriptAction(ORIGDisplayFormatUtil.displayCommaNumber(preScoreDataM.getDownPayment()),cmrDisplayMode,"","pre_score_down_payment","textboxCurrency","onblur=\"javascript:addComma(this);addDecimalFormat(this);calFinanceAmt();\" onKeyPress=\"isNumberOnKeyPress(this)\" onkeyup=\"isNumberOnkeyUp(this)\" onfocus=\"removeCommaField(this)\" "+ 
		"onMouseOver=\""+tooltipUtil.getTooltip(request,"prescore_down_payment")+"\" ","16") %></td>
	</tr>
	<tr>
