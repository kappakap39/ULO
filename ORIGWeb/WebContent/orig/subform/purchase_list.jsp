...
<table cellpadding="" cellspacing="0" width="100%" align="center" bgcolor="#FFFFFF">
					...
					<table class="gumayframe3" cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
						<tr><td class="TableHeader">
							<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
								<tr>
									...
									<td class="Bigtodotext3" align="center" width="28%"><%=MessageResourceUtil.getTextDescription(request, "CAMPAIGN") %></td>
									<td class="Bigtodotext3" align="center" width="27%"><%=MessageResourceUtil.getTextDescription(request, "SCHEME_COME") %></td>
									<td class="Bigtodotext3" align="center" width="15%"><%=MessageResourceUtil.getTextDescription(request, "LOAN_AMOUNT_APPLIED") %></td>
								</tr>
							</table> 
						</td></tr>
						<% if(loanDataM != null){ 
						...
						<tr><td align="center" class="gumaygrey2">
							...
							<tr>
								...
								<td class="jobopening2" align="center" width="25%"><a href="javascript:loadPopup('loan','LoadPLoanLoanPopup','1170','680','0','0','','<%=loanDataM.getLoanType() %>','')"><u><%=ORIGDisplayFormatUtil.displayHTML(mktDesc) %></u></a></td>
								<td class="jobopening2" align="center" width="28%"><%=ORIGDisplayFormatUtil.displayHTML(campaignDesc) %></td>
								<td class="jobopening2" align="center" width="27%"><%=ORIGDisplayFormatUtil.displayHTML(schemeDesc) %></td>
								<%if(com.eaf.orig.shared.constant.OrigConstant.INSTALLMENT_TYPE_STEP.equals(loanDataM.getInstallmentFlag())){%>
								<td class="jobopening2" align="center" width="15%"><%=MessageResourceUtil.getTextDescription(request, "STEP_INSTALLMENT") %></td>
								<%}else{ %>
								<td class="jobopening2" align="center" width="15%"><%=ORIGDisplayFormatUtil.displayCommaNumber(loanDataM.getLoanAmt()) %></td>
								<%}%>
							</tr>
							</table> 
						</td></tr>
	...
	<tr>
		<td width="84%"></td>
		<td align="right" width="7%"><INPUT type="button" name="addLoanBnt" value=" <%=MessageResourceUtil.getTextDescription(request, "ADD") %> " onClick="javascript:loadPopupLoan()" class="button_text" >
...
//<!--
	function loadPopupLoan(){
		loadPopup('loan','LoadPLoanLoanPopup','1170','680','0','0','','<%=applicationDataM.getLoanType() %>','');
	}
//-->
</SCRIPT>