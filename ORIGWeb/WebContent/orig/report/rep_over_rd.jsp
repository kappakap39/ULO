					...
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
						...
						<tr class="sidebar10"> <td align="center">
							...
							<TR>
								...
								<TD class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction(loanDataM.getMarketingCode(),displayMode,"5","fca_code_cr","25","mkt_code_desc1","textbox","","30","...","button_text","LoadRepfCaCodeCredit","","CREDITAPRV") %></TD>
							</TR>
							<TR>
								<TD class="textColS">To CA</TD>						
								<TD class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction(loanDataM.getMarketingCode(),displayMode,"5","tca_code_cr","25","mkt_code_desc2","textbox","","30","...","button_text","LoadReptCaCodeCredit","","CREDITAPRV") %></TD>
							</TR>
							<TR>
...
<!-- form action="FrontController" method="post" name="frmrefresh">
    ...
    <input type="hidden" name="page" value="RPT_OVER_RD">
</form-->
...
<form action="ORIGReportUtil" method="post" name="reportForm">
	...
	<input type="hidden" name="report_type" value="rep_over_rd">
<!--<input type="hidden" name="P_CHANNEL" value=""> 
    <input type="hidden" name="P_PRODUCT" value=""> 
    <input type="hidden" name="P_ORG_ID" value=""> 
    <input type="hidden" name="page" value="RPT_OVER_RD">-->
