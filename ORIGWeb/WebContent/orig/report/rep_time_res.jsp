					...
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
						...
						<tr class="sidebar10"> <td align="center">
							...
							<tr>
								...
								<TD class="inputCol" width="552"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction_ORIG(loanTypeVect,"" ,"loantype",displayMode,"") %></TD>
							</TR>
							<TR>
								<TD class="textColS">Decision Date From</TD>
							...
							<TR>
								<TD class="textColS">Decision Date To</TD>
...
<!-- form action="FrontController" method="post" name="frmrefresh">
    ...
    <input type="hidden" name="page" value="RPT_TIME_RES">
</form-->
...
function verifyForm()
{
	...
	else if(sourceFrm.t_c_date != null && sourceFrm.f_c_date != null)
	{
		...
		{
			alert('Please Select Decision Date To Equal or Greater Than Decision Date From !');
		}
		else 
		{
			var url = "";
...
<form action="ORIGReportUtil" method="post" name="reportForm">
	...
	<input type="hidden" name="report_type" value="rep_time_res">
<!--<input type="hidden" name="P_CHANNEL" value=""> 
    <input type="hidden" name="P_PRODUCT" value=""> 
    <input type="hidden" name="P_ORG_ID" value=""> 
    <input type="hidden" name="page" value="RPT_TIME_RES">-->
