		    	...
		    	<tr><td class="sidebar9">
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
						...
						<tr class="sidebar10"> <td align="center">
							...
							<tr>
								<TD class="textColS" width="142">Loan Type</TD>
								<TD class="textColS" width="552"><%=ORIGDisplayFormatUtil.displaySelectTagScriptAction_ORIG(loanTypeVect,null ,"loantype",displayMode," ") %>&nbsp;&nbsp;(Please Select =All Loan Type)</TD>
							</TR>
							<TR>
								<TD class="textColS">From Office</TD>
...
<!-- form action="FrontController" method="post" name="frmrefresh">
    ...
    <input type="hidden" name="page" value="RPT_REP_BY_LOAN_TYPE_SCREEN">
</form-->
...
if(		verifyForm()==true && veroff()==true)
{
		...
		reportForm.t_book_date.value = appFormName.t_book_date.value;
   	 	if(appFormName.loantype == null || appFormName.loantype.value == ''){
   	 		reportForm.f_loan.value = '01';
			reportForm.t_loan.value = '07';
			}
   	 	else{
			reportForm.f_loan.value = appFormName.loantype.value;
			reportForm.t_loan.value = appFormName.loantype.value;
			}
		reportForm.submit();
		return true;
}
...
<form action="ORIGReportUtil" method="post" name="reportForm">
	...
	<input type="hidden" name="f_loan" value="">
	<input type="hidden" name="t_loan" value="">
	<input type="hidden" name="report_type" value="rep_by_ltype">
