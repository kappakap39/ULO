		    	...
		    	<tr><td class="sidebar9">
					<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>	     		
						...
						<tr class="sidebar10"> <td align="center">
							...
							<tr>
								<td class="textColS">FromOffice</td>
								<TD class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction("01",displayMode,"5","foffice_code","25","office_code_desc1","textbox","","30","...","button_text","LoadRepfOfficeCode","สำนักงานใหญ่","OfficeInformation") %></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD class="textColS">From CMR</TD>
								<TD class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction(loanDataM.getMarketingCode(),displayMode,"5","fcmr_code","25","mkt_code_desc1","textbox","","30","...","button_text","LoadRepfCmrCode","","LoanOfficer") %></TD>
							</TR>
							<TR>
								<TD class="textColS">To CMR</TD>						
								<TD class="inputCol"><%=ORIGDisplayFormatUtil.displayPopUpTagScriptAction(loanDataM.getMarketingCode(),displayMode,"5","tcmr_code","25","mkt_code_desc2","textbox","","30","...","button_text","LoadReptCmrCode","","LoanOfficer") %></TD>
							</TR>
							<TR>
...
<!-- form action="FrontController" method="post" name="frmrefresh">
    ...
    <input type="hidden" name="page" value="RPT_CMR_PFM">
</form-->
...
if(	verifyForm()==true && veroff() == true){
	...
	if(appFormName.fcmr_code == null || appFormName.fcmr_code.value == '')
		{reportForm.fcmr_code.value = '0001';}
    else
    	{reportForm.fcmr_code.value = appFormName.fcmr_code.value;}
    if(appFormName.tcmr_code == null || appFormName.tcmr_code.value == '')
    	{reportForm.tcmr_code.value = 'zzzz'}
    else
    	{reportForm.tcmr_code.value = appFormName.tcmr_code.value;}
...
{
	var sourceFrm = document.appFormName;
	if(sourceFrm.fcmr_code == null || sourceFrm.fcmr_code.value == '')
	{
			{sourceFrm.fcmr_code.value = "0001";}
		
	}else if(sourceFrm.tcmr_code == null || sourceFrm.tcmr_code.value == '')
	{
			{sourceFrm.fcmr_code.value = "ZZZZ";}
		
	}else if(sourceFrm.fcmr_code != null && sourceFrm.tcmr_code != null)
	{
		return true;
	}
	return false;
...
<form action="ORIGReportUtil" method="post" name="reportForm">
	...
	<input type="hidden" name="fcmr_code" value="0001">
	<input type="hidden" name="tcmr_code" value="ZZZZ">
	<input type="hidden" name="f_book_date" value="">
	<input type="hidden" name="t_book_date" value="">
	<input type="hidden" name="report_type" value="rep_cmr_pfm">
<!--<input type="hidden" name="P_CHANNEL" value=""> 
    <input type="hidden" name="P_PRODUCT" value=""> 
    <input type="hidden" name="P_ORG_ID" value=""> 
    <input type="hidden" name="page" value="RPT_CMR_PFM">-->
