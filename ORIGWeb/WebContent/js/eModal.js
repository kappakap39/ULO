...
; (function (define) {
    define(['jquery'], function ($) {
        ...
        function _getModalInstance(sectionId) {
            /// <summary>
            ...
            if (!$modal) {
                ...
                $modal = createModalElement(sectionId);
                linq.element = $modal;
            }
            ...
            function createModalElement(sectionId) {
                /// <summary></summary>
                /// <returns type="jQuery object"></returns>
              
                return $('<div id ="'+sectionId+'" class="modal fade" tabindex="-1"><style>.modal-xl{width:96%;}</style>'
        ...
        function _setup(params, title,sectionId) {
            /// <summary></summary>
...
//            linq.catch = linq.fail;
            ...
            // Lazy loading
            var $ref = _getModalInstance(sectionId);
        ...
        function alert(params, title,sectionId) {
            /// <summary>Non blocking alert whit bootstrap.</summary>
            /// <param name="params"></param>
            /// <param name="title"></param>
            /// <returns type=""></returns>

            _setup(params, title,sectionId);
        ...
        function iframe(params, title,sectionId) {
        	$modal =false;
            var html = ('<div class=modal-body style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%</div>' +
                        '<iframe class="embed-responsive-item" frameborder=0 src="%0%" seamless="seamless" webkitallowfullscreen mozallowfullscreen allowfullscreen style="width:100%;height:80vh;display:block;"/>')
