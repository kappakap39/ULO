...
var menuBtn=_2c0[i];
_2c2(menuBtn);
menuBtn.children("div.menu-item").each(function(){
_2c6(_2bf,$(this));
});
menuBtn.bind("mouseenter",function(){
if(time){
clearTimeout(time);
time=null;
}
...
function _2c1(menuBtn){
_2c0.push(menuBtn);
menuBtn.find(">div").each(function(){
var item=$(this);
...
function _2c2(menuBtn){
menuBtn.addClass("menuBtn").find(">div").each(function(){
var item=$(this);
...
item.unbind(".menuBtn");
item.bind("mousedown.menuBtn",function(){
return false;
}).bind("click.menuBtn",function(){
...
var item=$(_2c7).menuBtn("getItem",this);
$.data(_2c7,"menuBtn").options.onClick.call(_2c7,item);
}).bind("mouseenter.menuBtn",function(e){
...
}).bind("mouseleave.menuBtn",function(e){
...
function _2cb(_2cc){
var opts=$.data(_2cc,"menuBtn").options;
_2ca($(_2cc));
$(document).unbind(".menuBtn");
opts.onHide.call(_2cc);
return false;
};
function _2cd(_2ce,pos){
var opts=$.data(_2ce,"menuBtn").options;
if(pos){
opts.left=pos.left;
opts.top=pos.top;
...
$(document).unbind(".menuBtn").bind("mousedown.menuBtn",function(){
_2cb(_2ce);
$(document).unbind(".menuBtn");
return false;
});
...
function _2cf(menuBtn,pos,_2d0){
if(!menuBtn){
return;
}
if(pos){
...
menuBtn.show(0,function(){
if(!menuBtn[0].shadow){
menuBtn[0].shadow=$("<div class=\"menu-shadow\"></div>").insertAfter(menuBtn);
}
menuBtn[0].shadow.css({display:"block",zIndex:$.fn.menuBtn.defaults.zIndex++,left:menuBtn.css("left"),top:menuBtn.css("top"),width:menuBtn.outerWidth(),height:menuBtn.outerHeight()});
menuBtn.css("z-index",$.fn.menuBtn.defaults.zIndex++);
if(_2d0){
_2d0();
}
});
};
function _2ca(menuBtn){
if(!menuBtn){
return;
}
_2d1(menuBtn);
menuBtn.find("div.menu-item").each(function(){
if(this.submenu){
_2ca(this.submenu);
}
$(this).removeClass("menu-active");
...
var _2d4=null;
var tmp=$("<div></div>");
function find(menuBtn){
menuBtn.children("div.menu-item").each(function(){
var item=$(_2d3).menuBtn("getItem",this);
...
var menuBtn=$(_2da);
if(_2db.parent){
menuBtn=_2db.parent.submenu;
}
var item=$("<div class=\"menu-item\"></div>").appendTo(menuBtn);
...
$.fn.menuBtn=function(_2e3,_2e4){
if(typeof _2e3=="string"){
return $.fn.menuBtn.methods[_2e3](this,_2e4);
}
_2e3=_2e3||{};
return this.each(function(){
var _2e5=$.data(this,"menuBtn");
if(_2e5){
$.extend(_2e5.options,_2e3);
}else{
_2e5=$.data(this,"menuBtn",{options:$.extend({},$.fn.menuBtn.defaults,_2e3)});
init(this);
}
$(this).css({left:_2e5.options.left,top:_2e5.options.top});
});
};
$.fn.menuBtn.methods={show:function(jq,pos){
return jq.each(function(){
_2cd(this,pos);
});
},hide:function(jq){
...
return jq.each(function(){
var item=$(this).menuBtn("getItem",_2e7.target);
if(item.iconCls){
...
$.fn.menuBtn.defaults={zIndex:110000,left:0,top:0,onShow:function(){
},onHide:function(){
...
if(opts.menuBtn){
$(opts.menuBtn).menuBtn({onShow:function(){
...
if(left+$(opts.menuBtn).outerWidth()+5>$(window).width()){
left=$(window).width()-$(opts.menuBtn).outerWidth()-5;
}
$("body>div.menu-top").menuBtn("hide");
$(opts.menuBtn).menuBtn("show",{left:left,top:btn.offset().top+btn.outerHeight()});
btn.blur();
};
};
...
var t=$(_2f6);
return $.extend({},$.fn.linkbutton.parseOptions(_2f6),{menuBtn:t.attr("menuBtn"),duration:t.attr("duration")});
};
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menuBtn:null,duration:100});
})(jQuery);
(function($){
function init(_2f7){
...
var t=$(_301);
return $.extend({},$.fn.linkbutton.parseOptions(_301),{menuBtn:t.attr("menuBtn"),duration:t.attr("duration")});
};
$.fn.splitbutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menuBtn:null,duration:100});
})(jQuery);
(function($){
function init(_302){
$(_302).hide();
...
if(opts.menuBtn){
_309.menuBtn=$(opts.menuBtn).menuBtn({onClick:function(item){
_30a(item);
}});
var _30b=_309.menuBtn.children("div.menu-item:first[selected]");
if(!_30b.length){
_30b=_309.menuBtn.children("div.menu-item:first");
}
...
mb.prependTo(_309.searchbox).menubutton({menuBtn:_309.menuBtn,iconCls:item.iconCls});
...
return $.data(jq[0],"searchbox").menuBtn;
},textbox:function(jq){
...
return jq.each(function(){
var menuBtn=$.data(this,"searchbox").menuBtn;
if(menuBtn){
menuBtn.children("div.menu-item[name=\""+name+"\"]").triggerHandler("click");
}
});
},destroy:function(jq){
return jq.each(function(){
var menuBtn=$(this).searchbox("menuBtn");
if(menuBtn){
menuBtn.menuBtn("destroy");
}
...
var t=$(_31a);
return {width:(parseInt(_31a.style.width)||undefined),prompt:t.attr("prompt"),value:t.val(),menuBtn:t.attr("menuBtn"),searcher:(t.attr("searcher")?eval(t.attr("searcher")):undefined)};
};
$.fn.searchbox.defaults={width:"auto",prompt:"",value:"",menuBtn:null,searcher:function(_31b,name){
}};
})(jQuery);
(function($){
function init(_31c){
...
var menuBtn=$(_370).find(".calendar-menuBtn");
...
show(_372);
var menuBtn=$(_372).find(".calendar-menu-month-inner");
menuBtn.find("td.calendar-selected").removeClass("calendar-selected");
menuBtn.find("td:eq("+(opts.month-1)+")").addClass("calendar-selected");
};
function _374(_375,_376){
var opts=$.data(_375,"calendar").options;
opts.year+=_376;
show(_375);
var menuBtn=$(_375).find(".calendar-menu-year");
menuBtn.val(opts.year);
};
function _377(_378){
...
var menuBtn=$(_378).find(".calendar-menu");
menuBtn.find(".calendar-selected").removeClass("calendar-selected");
...
function _379(){
var menuBtn=$(_378).find(".calendar-menu");
var year=menuBtn.find(".calendar-menu-year").val();
var _37a=menuBtn.find(".calendar-selected").attr("abbr");
if(!isNaN(year)){
