...
//    Comment This Not Used For KLOP #SeptemWi
...
//    }
    ...
    /**Fix for append  boxy to frame #SeptemWi*/
    var frame = (document.getElementById('frame-module') == null)? document.body : '.frame-module';
    	frame = (document.getElementById('plan-dialog') == null)? frame : '.ui-dialog';
    
    this.boxy.css('display', 'none').appendTo(frame);
    this.toTop();
    
// Comment #SeptemWi Change Logic Center Element
...
//  Fix Position Boxy Center Element #SeptemWi
    this.boxy.addClass('fixed');
    var frameBoxy = (document.getElementById('frame-module') == null)? document.body : 'div.frame-module';
    	frameBoxy = (document.getElementById('plan-dialog') == null)? frameBoxy : '.ui-dialog';
    
    $('.boxy-wrapper').position({
    	    my: 'center',
    	    at: 'center',
    	    of: $(frameBoxy)
    });
...
jQuery.extend(Boxy, {
    ...
    ask: function(question, answers, callback, options) {
        ...
        buttons.html(jQuery.map(Boxy._values(answers), function(v) {
        	return "<input type='button' class='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only' value='" + v + "' />";
        }).join(' '));
...
//          Boxy._setupModalResizing();
            ...
            if (this.options.closeable) {
                jQuery(document.body).bind('keypress.boxy', function(evt) {
                    ...
                    if (key == 27) {
                        self.hide();
                        jQuery(frame).unbind('keypress.boxy');
                    }
                });
            }
        }
...
/**Function Confirm Function #SeptemWi*/
function confirmMassage(massage,handleFunc){
	 $('.boxy-wrapper').remove();
	 $('.boxy-modal-blackout').remove();
	  Boxy.confirm(massage,
	  function() { 
		$('.boxy-wrapper').remove();
		$('.boxy-modal-blackout').remove(); }
	  , {title: 'Message'});
...
/**Function Alert Massage #SeptemWi*/
...
function alertMassageFunc(massage,func){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.alert(massage,function(){
...
function alertMassageFuncParam1(massage,func,param1){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.alert(massage,function(){
		 			if(func != null) new func(param1);
		 			$('.boxy-wrapper').remove();
					$('.boxy-modal-blackout').remove();
	 			},{title: 'Alert Message'});
//	 #septem focus boxy-wrapper
	$('.boxy-wrapper').focus();
	$('.boxy-wrapper').focus();
}
function alertMassageYesNoFunc(massage,yesFunc,noFunc){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
...
function alertMassageYesNoFunc1(massage,yesFunc,noFunc,param1){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.ask(massage, ["Yes", "No"], function(val) {		 	
		      if("Yes" == val){
		    	  if(yesFunc != null) new yesFunc(param1);
		      }
		      if("No" == val){
		    	  if(noFunc != null) new noFunc();
		      }
...
function alertMassageYesNoFunc2(massage,yesFunc,noFunc,param1,param2){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.ask(massage, ["Yes", "No"], function(val) {		 	
		      if("Yes" == val){
...
//Praisan Khunkaew 20120727
function alertButtonMassageYesNoFunc(massage,yesFunc,noFunc){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.ask(massage, ["Yes", "No"], function(val) {		 	
		      if("Yes" == val){
...
function alertMassageFocus(massage,fieldName){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.alert(massage ,function(){
...
function alertMassageSelection(massage,fieldName){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	 Boxy.alert(massage ,function(){
					document.getElementById(fieldName).focus();
...
function destoryMassage(){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
}
function alertMassageERROR(massage){
	$('.boxy-wrapper').remove();
	$('.boxy-modal-blackout').remove();
	Boxy.alert(massage, function(){		     
		  	$('.boxy-wrapper').remove();
