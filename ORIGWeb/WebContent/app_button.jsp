...
<TABLE height=1 cellSpacing=0 cellPadding=0 width="100%" bgColor=#FFFFFF border=0 align="center">   				  
    ...
    <TR>
		...
		<TD align="right">
			<INPUT class="button_text" onclick="" type="button" value=" <%=MessageResourceUtil.getTextDescription(request, "SUBMIT") %> " name="submitBtn">
			<INPUT class="button_text" onclick="" type="button" value=" <%=MessageResourceUtil.getTextDescription(request, "SAVE") %> " name="saveBtn">
		</TD>
       </TR>
