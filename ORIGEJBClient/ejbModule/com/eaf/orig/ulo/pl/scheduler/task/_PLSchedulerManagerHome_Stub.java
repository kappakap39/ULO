...
public class _PLSchedulerManagerHome_Stub extends Stub implements PLSchedulerManagerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.eaf.orig.ulo.pl.scheduler.task.PLSchedulerManagerHome:0000000000000000", 
    ...
    public PLSchedulerManager create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (PLSchedulerManager) in.read_Object(PLSchedulerManager.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.eaf.orig.ulo.pl.scheduler.task.PLSchedulerManagerHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    PLSchedulerManager result = ((com.eaf.orig.ulo.pl.scheduler.task.PLSchedulerManagerHome)so.servant).create();
                    return (PLSchedulerManager)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
