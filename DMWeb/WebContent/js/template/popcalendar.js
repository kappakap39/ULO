...
//					aData =	ctl2.value.split(formatChar);
				...
				if($IE){
					...
					var crossTop = 0;					
					if(posi=="left"){						
						crossLeft =	(fixedX==-1? ctl.offsetLeft-(ctl.offsetWidth + 195)+leftpos-image:fixedX)-11;					
						crossTop = (fixedY==-1 ? ctl.offsetTop + toppos + ctl.offsetHeight + 2 : fixedY)-25;
					}else{ 
						crossLeft = (fixedX==-1 ? ctl.offsetLeft+leftpos-image :fixedX)-8;
						crossTop = (fixedY==-1 ? ctl.offsetTop + toppos + ctl.offsetHeight + 2 : fixedY)-25;
					}
					...
					if(posi=="left"){
						crossobj.left =	(fixedX==-1? ctl.offsetLeft-(ctl.offsetWidth + 195)+leftpos-image:fixedX)-10;					
						crossobj.top = (fixedY==-1 ? ctl.offsetTop + toppos + ctl.offsetHeight + 2 : fixedY)-25;
					}else{ 
						crossobj.left = (fixedX==-1 ? ctl.offsetLeft+leftpos-image :fixedX)-8;
						crossobj.top = (fixedY==-1 ? ctl.offsetTop + toppos + ctl.offsetHeight + 2 : fixedY)-25;
					}
				}
