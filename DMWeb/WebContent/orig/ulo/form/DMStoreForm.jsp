...
<jsp:include page="/orig/ulo/button/DMStoreButton.jsp" flush="true"/>
<%
...
<section class="work_area">
	...
	<header class="titlecontent"><%=LabelUtil.getText(request,"DM_DOC_CHECK_LIST")%></header>
	<div class="row">
		<div class="col-xs-12">
			<jsp:include page="/orig/ulo/subform/DMDocumentCheckListSubForm.jsp" flush="true"/>
		</div>
	</div>
