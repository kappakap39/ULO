...
public class SaveDMBorrowWebAction extends WebActionHelper implements WebAction {
	private static transient Logger logger = Logger.getLogger(SaveDMBorrowWebAction.class);
	@Override
	public Event toEvent() {
		DocumentManagementDataM dmManageDataM = DMFormHandler.getObjectForm(getRequest());
		UserDetailM userM = (UserDetailM) getRequest().getSession().getAttribute("ORIGUser");
		return new DMEvent(DMEvent.DM_SAVE_BORROW,dmManageDataM,userM);
	}
