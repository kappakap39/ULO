...
public class ApplicationLogDataM implements Serializable,Cloneable{
	...
	private BigDecimal reprocessVersion;	//ORIG_APPLICATION_LOG.REPROCESS_VERSION
	...
	public BigDecimal getReprocessVersion() {
		return reprocessVersion;
	}
	public void setReprocessVersion(BigDecimal reprocessVersion) {
		this.reprocessVersion = reprocessVersion;
	}		
}
