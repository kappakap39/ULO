...
public class KBankResponseHeader  {
    ...
    private com.kasikornbank.kvi.editkviapp.proxy.KBankResponseError[] error;
    ...
    public com.kasikornbank.kvi.editkviapp.proxy.KBankResponseError[] getError() {
        return error;
    }

    public void setError(com.kasikornbank.kvi.editkviapp.proxy.KBankResponseError[] error) {
        this.error = error;
    }
