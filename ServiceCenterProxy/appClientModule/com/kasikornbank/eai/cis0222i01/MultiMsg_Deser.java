...
public class MultiMsg_Deser extends com.ibm.ws.webservices.engine.encoding.ser.BeanDeserializer {
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_2_127) {
          if (objValue instanceof java.util.List) {
            com.kasikornbank.eai.cis0222i01.RefField[] array = new com.kasikornbank.eai.cis0222i01.RefField[((java.util.List)objValue).size()];
            ((java.util.List)objValue).toArray(array);
            ((MultiMsg)value).setRefFieldVect(array);
          } else { 
            ((MultiMsg)value).setRefFieldVect((com.kasikornbank.eai.cis0222i01.RefField[])objValue);}
          return true;}
        return false;
    }
