...
public class WmProceedAction extends ProcessActionHelper {

	private Logger logger = Logger.getLogger(WmProceedAction.class);
	...
	public Object processAction() {
	    ...
	    try{
    		...
    		String endPointUrl = SystemConfig.getProperty("WORK_MANAGER_PROCEED_ACTION_URL");
