...
public class WmPostApprovalAction extends ProcessActionHelper {

	private Logger logger = Logger.getLogger(WmPostApprovalAction.class);
	...
	public Object processAction() {
	    ...
	    try{
    		...
    		String endPointUrl = SystemConfig.getProperty("WORK_MANAGER_POSTAPPROVAL_ACTION_URL");
    		WmTask task = (WmTask) objectForm;
    		
    		PostApprovalDataM body = new PostApprovalDataM();
