...
public class WmFullFraudAction extends ProcessActionHelper {

	private Logger logger = Logger.getLogger(WmFullFraudAction.class);
	...
	public Object processAction() {
	    ...
	    try{
    		...
    		String endPointUrl = SystemConfig.getProperty("WORK_MANAGER_FULLFRAUD_ACTION_URL");
    		WmTask task = (WmTask) objectForm;
    		
    		FraudResultM body = gson.fromJson(task.getData().getTaskData(), FraudResultM.class);
