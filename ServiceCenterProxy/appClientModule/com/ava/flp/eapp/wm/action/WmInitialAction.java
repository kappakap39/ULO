...
public class WmInitialAction extends ProcessActionHelper {

	private Logger logger = Logger.getLogger(WmInitialAction.class);
	
	@Override
	public Object processAction() {
		logger.debug("Start WmInitialAction");
		...
		try{
			...
			logger.debug("WmInitialAction Start Create Request Header");
	        HttpHeaders httpHeaderReq = new HttpHeaders();
	        httpHeaderReq.add("Content-Type", "application/json; charset=UTF-8");
	
	        logger.debug("WmInitialAction Start Create Request Body");
		...
		logger.debug("End WmInitialAction");
		return response;
	}
}
