...
public class WmInitialCJDAction extends ProcessActionHelper {

	private Logger logger = Logger.getLogger(WmInitialCJDAction.class);
	
	@Override
	public Object processAction() {
		logger.debug("Start WmInitialCJDAction");
		...
		try{
			...
			logger.debug("WmInitialCJDAction Start Create Request Header");
	        HttpHeaders httpHeaderReq = new HttpHeaders();
	        httpHeaderReq.add("Content-Type", "application/json; charset=UTF-8");
	
	        logger.debug("WmInitialCJDAction Start Create Request Body");
		...
		logger.debug("End WmInitialCJDAction");
		return response;
	}
}
