...
public class IncomeCalculationDecisionServiceRequestMapper extends DecisionServiceRequestMapper{
	private static transient Logger logger = Logger.getLogger(IncomeCalculationDecisionServiceRequestMapper.class);
