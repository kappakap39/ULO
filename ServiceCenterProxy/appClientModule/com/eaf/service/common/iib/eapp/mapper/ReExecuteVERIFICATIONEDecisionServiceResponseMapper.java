...
public class ReExecuteVERIFICATIONEDecisionServiceResponseMapper extends EDecisionServiceResponseMapper {
	private static transient Logger logger = Logger.getLogger(ReExecuteVERIFICATIONEDecisionServiceResponseMapper.class);
