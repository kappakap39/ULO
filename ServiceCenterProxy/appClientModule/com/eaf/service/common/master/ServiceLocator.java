...
public class ServiceLocator {
	...
	private static transient Logger logger = Logger.getLogger(ServiceLocator.class);
	...
	private static String JAVA_ENV = "";
	...
	public Connection getConnection(int dbType) throws ServiceLocatorException{
		try{
	...
	public Connection getJdbcConnection(int dbType) throws ServiceLocatorException{
		try{
	...
	public static String getJAVA_ENV()
	{
		return JAVA_ENV;
	}
	  
	public static void setJAVA_ENV(String jAVA_ENV)
	{
		JAVA_ENV = jAVA_ENV;
	}
}
