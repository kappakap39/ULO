...
public class FLPServiceSoapProxy{
    ...
    public class Descriptor {
        ...
        private void initCommon() {
            _proxy = _service.getFLPServiceSoap();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("http://tempuri.org/", "FLPServiceSoap");
    ...
    public FLPServiceSoapProxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    public FLPServiceSoapProxy(URL wsdlLocation, QName serviceName) {
