...
public class ObjectDAO {
	private static final transient Logger logger = LogManager.getLogger(ObjectDAO.class);
	public final Connection getConnection(){
		try{
			ServiceLocator origService = ServiceLocator.getInstance();
			return origService.getConnection(ServiceLocator.WIDGET);  
		}catch(Exception e){ 
		    logger.fatal("Connection is null",e);
		}
		return null;
	}
	public final Connection getConnection(int dbType){
		try{
			ServiceLocator OrigService = ServiceLocator.getInstance();
	...
	public final void closeConnection(Connection conn, ResultSet rs, PreparedStatement ps) throws Exception{ 
		try{
