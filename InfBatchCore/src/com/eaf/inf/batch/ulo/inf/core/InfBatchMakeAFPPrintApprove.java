...
public class InfBatchMakeAFPPrintApprove extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchMakeAFPPrintApprove.class);	
	@Override
