...
public class InfBatchMakePDF extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchMakePDF.class);
	...
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException {
		...
		try{
			GenerateFileDataM generateFileData = getGenerateFileData(BATCH_ID, getGenerateType(BATCH_ID), Formatter.Format.YYYYMMDD);
