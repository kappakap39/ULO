...
public class InfBatchKmAlertPerformance extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchKmAlertPerformance.class);
