...
public class InfBatchCardLinkCustomerOccupation extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchCardLinkCustomerOccupation.class);
