...
public class InfBatchCardLinkResult  extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchCardLinkResult.class);
	@Override
	...
	try{
		ProcessTaskDataM processTask = new ProcessTaskDataM("CARD_LINK_RESULT_TASK");
