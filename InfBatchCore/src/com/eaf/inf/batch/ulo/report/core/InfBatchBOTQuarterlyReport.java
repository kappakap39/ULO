...
public class InfBatchBOTQuarterlyReport extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchBOTQuarterlyReport.class);
