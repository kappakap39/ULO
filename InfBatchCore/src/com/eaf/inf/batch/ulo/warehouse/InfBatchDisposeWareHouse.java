...
public class InfBatchDisposeWareHouse extends InfBatchHelper {
	private static transient Logger logger = Logger.getLogger(InfBatchDisposeWareHouse.class);
	...
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException {	
		...
		try{
			ProcessTaskDataM processTask = new ProcessTaskDataM(InfBatchConstant.task.WAREHOUSE_DISPOSE_TASK);
