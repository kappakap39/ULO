...
public class InfBatchDeleteNCBData  extends InfBatchHelper {
	private static transient Logger logger = Logger.getLogger(InfBatchDeleteNCBData.class);
	...
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException {	
		InfBatchResponseDataM infBatchResponse = new InfBatchResponseDataM();
		 ...
		 try {
			ProcessTaskDataM processTask = new ProcessTaskDataM(InfBatchConstant.task.DELETE_NCB_TASK);
