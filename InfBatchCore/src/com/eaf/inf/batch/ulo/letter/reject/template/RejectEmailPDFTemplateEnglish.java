...
public class RejectEmailPDFTemplateEnglish extends TemplateBuilderHelper{
	private static transient Logger logger = Logger.getLogger(RejectEmailPDFTemplateEnglish.class);
	...
	private void setCallCenterInfo(RejectTemplateVariableDataM rejectTemplateVariable,HashMap<String,String> hCallCenterNo){
		...
		if(REJECT_LETTER_PDF_PRODUCT_NAME_CC.equals(productType)){
			callCenterNoCC.append(kcc_slast)
				.append(" ").append(REJECT_LETTER_PDF_CONJUNCTION_FOR_EN).append(" ")
				.append(productName);
			kcc_slast="/";
			...
			callCenterNoKEC.append(kec_slast)
				...
				.append(productName);
			kec_slast="/";
		}else if(REJECT_LETTER_PDF_PRODUCT_NAME_KPL.equals(rejectTemplateVariable.getBusinessClassId())){
