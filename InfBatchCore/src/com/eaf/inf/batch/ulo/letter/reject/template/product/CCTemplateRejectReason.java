...
public class CCTemplateRejectReason extends RejectTemplateReasonProductHelper {
	private static transient Logger logger = Logger.getLogger(CCTemplateRejectReason.class);
