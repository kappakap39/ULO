...
public class RejectEmailPDFTemplateEnglishIncrease extends TemplateBuilderHelper {
	private static transient Logger logger = Logger.getLogger(RejectEmailPDFTemplateEnglishIncrease.class);
