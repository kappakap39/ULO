...
public class GenerateAllAppInterfaceTemplate2 extends GenerateRejectLetterHelper {
	private static transient Logger  logger  = Logger.getLogger(GenerateInterfaceTemplate2.class);
...
//				logger.debug("generateTextFormat>>"+generateTextFormat);
				...
				rejectLetterInterfaceResponse.setSubInterfaceCode(REJECT_LETTER_INTERFACE_CODE_T2);
	 ...
	 private RejectLetterLogDataM getRejectLetterLog(ArrayList<String> aplicationRecordIds,String letterNo,String letterType,String language,String applicationGroupId,String sendTo,int lifeCycle,String templateId) throws Exception{
    	 ...
    	 getRejectLetterLog.setInterfaceCode(REJECT_LETTER_INTERFACE_CODE);
    	 ...
    	 getRejectLetterLog.setSubInterfaceCode(REJECT_LETTER_INTERFACE_CODE_T2);
