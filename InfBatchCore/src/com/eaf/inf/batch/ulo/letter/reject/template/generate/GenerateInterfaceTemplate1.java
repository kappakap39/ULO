...
public class GenerateInterfaceTemplate1 extends GenerateRejectLetterHelper {
...
//			}
			...
			rejectLetterInterfaceResponse.setInterfaceCode(REJECT_LETTER_INTERFACE_CODE_T1);
     ...
     private RejectLetterLogDataM getRejectLetterLog(ArrayList<String> aplicationRecordIds,String letterNo,String letterType,String language,String applicationGroupId,String sendTo,int lifeCycle,String templateId) throws Exception{
    	 ...
    	 rejectLetterLog.setInterfaceCode(REJECT_LETTER_INTERFACE_CODE_T1);
     ...
     private void insertInfBatchLog(ArrayList<String> aplicationRecordIds,String letterNo,String letterType,String language,String applicationGroupId,String sendTo){
    	 ...
    	 try {
    		 ...
    		 if(!InfBatchUtil.empty(aplicationRecordIds)){
    			 for(String applicationRecordId : aplicationRecordIds){
    				 ...
    				 infBatchLogDataM.setInterfaceCode(REJECT_LETTER_INTERFACE_CODE_T1);
