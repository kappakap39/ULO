...
public class NotificationEODBranchSummaryTask extends InfBatchObjectDAO implements TaskInf{
	private static transient Logger logger = Logger.getLogger(NotificationEODBranchSummaryTask.class);
	...
	public ArrayList<TaskObjectDataM> getTaskObjects() throws TaskException{
		try{
			...
			NotificationEODRequestDataM notificationEodRequest = notificationDAO.getNotificationEodBranchSummaryRequest();
