...
public class RealtimeTemplateOther extends NotificationTemplateHelper{
	private static transient Logger logger = Logger.getLogger(RealtimeTemplateOther.class);
	...
	public NotificationTemplateResponseDataM processNotifyTemplate(NotificationTemplateRequestDataM templateRequest)throws Exception{
		...
		ArrayList<String> smsTemplates = hListTemplate.get(NOTIFICATION_SEND_TO_TYPE_SELLER);
