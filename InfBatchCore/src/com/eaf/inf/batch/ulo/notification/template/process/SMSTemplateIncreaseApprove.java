...
public class SMSTemplateIncreaseApprove extends TemplateBuilderHelper  {
	private static transient Logger logger = Logger.getLogger(SMSTemplateIncreaseApprove.class);
	@Override
...
//			logger.debug(">>GET TEMPLATE VARIALBE<< By condition ="+ new Gson().toJson(receipientInfos));
			if(receipientInfos.size()>0){
				HashMap<String, Object> hData = dao.getSMSInCreaseApproveValues(receipientInfos);
