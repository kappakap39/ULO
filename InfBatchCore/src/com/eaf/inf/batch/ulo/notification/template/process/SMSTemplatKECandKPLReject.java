...
public class SMSTemplatKECandKPLReject extends TemplateBuilderHelper{
	
	private static transient Logger logger = Logger.getLogger(SMSTemplatKECandKPLReject.class);
	@Override
...
//			logger.debug(">>GET TEMPLATE VARIALBE<< By condition ="+ new Gson().toJson(receipientInfos));	
			if(!InfBatchUtil.empty(receipientInfos)){
				HashMap<String, Object> hData = dao.getSMSTemplateKECandKPLReject(receipientInfos);
