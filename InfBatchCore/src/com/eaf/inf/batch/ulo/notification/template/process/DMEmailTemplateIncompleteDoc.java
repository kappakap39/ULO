...
public class DMEmailTemplateIncompleteDoc extends TemplateBuilderHelper{
	private static transient Logger logger = Logger.getLogger(DMEmailTemplateIncompleteDoc.class);
	@Override
	public TemplateVariableDataM getTemplateVariable() {
		...
		try {
			...
			if(!InfBatchUtil.empty(dmNotifications)){
				...
				HashMap<String,Object> mapData = dao.getDMIncompletePhysicalDocumentValues(dmNotifications);
