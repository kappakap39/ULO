...
public class SMSTemplateNonCashDay1Approve extends TemplateBuilderHelper{
	private static transient Logger logger = Logger.getLogger(SMSTemplateNonCashDay1Approve.class);
	@Override
...
//			logger.debug(">>GET TEMPLATE VARIALBE<< By condition ="+ new Gson().toJson(receipientInfos));
			if(!InfBatchUtil.empty(receipientInfos)){
				HashMap<String, Object> hData = dao.getSMSnonCashDay1ApproveValues(receipientInfos);
