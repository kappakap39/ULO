...
public class InfBatchNotificationIncomplete extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchNotificationIncomplete.class);
	@Override
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException {	
		InfBatchResponseDataM infBatchResponse = new InfBatchResponseDataM();
		 ...
		 try {
			ProcessTaskDataM processTask = new ProcessTaskDataM(InfBatchConstant.task.NOTIFICATION_WARE_HOUSE_INCOMPLETE_TASK);
