...
public class RealtimeTemplateCustomer extends NotificationTemplateHelper{
	private static transient Logger logger = Logger.getLogger(RealtimeTemplateCustomer.class);
