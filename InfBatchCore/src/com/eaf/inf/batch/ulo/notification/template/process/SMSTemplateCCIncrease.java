...
public class SMSTemplateCCIncrease  extends TemplateBuilderHelper{
	...
	public TemplateVariableDataM getTemplateVariable() {
		//TEMPLATE {CARD_CODE} {CREDIT_LIMIT}
...
//			logger.debug(">>GET TEMPLATE VARIALBE<< By condition ="+ new Gson().toJson(receipientInfos));
				HashMap<String, Object> hData = dao.getSMSTemplateCCIncrease(receipientInfos,templateMaster);
