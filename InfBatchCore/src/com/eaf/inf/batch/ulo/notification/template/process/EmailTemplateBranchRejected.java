...
public class EmailTemplateBranchRejected extends TemplateBuilderHelper{
	private static transient Logger logger = Logger.getLogger(EmailTemplateBranchRejected.class);
	@Override
