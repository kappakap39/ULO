...
public class SMSTemplateRejectDocumentList extends TemplateBuilderHelper{
	private static transient Logger logger = Logger.getLogger(SMSTemplateRejectDocumentList.class);
...
//			logger.debug(">>GET TEMPLATE VARIALBE<< By condition ="+ new Gson().toJson(receipientInfos));
			if(!InfBatchUtil.empty(receipientInfos)){
				HashMap<String, Object> hData = dao.getSMSTemplateRejectDocumentList(receipientInfos,templateMaster);
