...
public class InfBatchNotificationNotReceive extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchNotificationNotReceive.class);
	@Override
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException {	
		InfBatchResponseDataM infBatchResponse = new InfBatchResponseDataM();
		 ...
		 try {
			ProcessTaskDataM processTask = new ProcessTaskDataM(InfBatchConstant.task.NOTIFICATION_WARE_HOUSE_NOT_RECEIVE_TASK);
