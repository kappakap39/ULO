...
public class InfBatchSetupLoanResult extends InfBatchHelper {
	private static transient Logger logger = Logger.getLogger(InfBatchSetupLoanResult.class);
	private static final String CFG_TASK_CLASS_NAME = "SETUP_LOAN_RESULT_TASK";
