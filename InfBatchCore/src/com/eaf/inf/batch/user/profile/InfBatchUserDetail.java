...
public class InfBatchUserDetail extends InfBatchHelper{
	private static transient Logger logger = Logger.getLogger(InfBatchUserDetail.class);
	@Override
	public InfBatchResponseDataM processAction(InfBatchRequestDataM infBatchRequest) throws InfBatchException,UploadManualFileException {
		...
		try{
			ProcessTaskDataM processTask = new ProcessTaskDataM("PURGE_INACTIVE_USERDATA_TASK");
