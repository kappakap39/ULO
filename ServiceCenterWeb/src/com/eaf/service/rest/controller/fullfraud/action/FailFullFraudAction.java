...
import com.eaf.service.rest.controller.fullfraud.FullFraudResultController;
...
public class FailFullFraudAction extends ProcessActionHelper{
	private static Logger logger = Logger.getLogger(FailFullFraudAction.class);
	...
	public Object processAction(){
		...
		try{
			...
			if (ServiceCache.lookup("JOBSTATE_PENDING_FULLFRAUD", applicationGroup.getJobState())) {
				...
				applicationGroup.setFullFraudFlag("Y");
				//applicationGroup.setFraudDecision(SystemConstant.getConstant("FRAUD_FLAG"));
				// Call ODM
				...
				if(ServiceResponse.Status.SUCCESS.equals(decisionResultCode)){
					...
					//Call UpdateApprovalStatus
					FullFraudResultController.UpdateApprovalStatusFullFruad(applicationGroup);
