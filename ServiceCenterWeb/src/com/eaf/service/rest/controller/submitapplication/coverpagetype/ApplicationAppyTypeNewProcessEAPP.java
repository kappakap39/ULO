...
public class ApplicationAppyTypeNewProcessEAPP implements ApplicationAppyTypeProcess {
	
	private static Logger logger = Logger.getLogger(ApplicationAppyTypeNewProcessEAPP.class);	
...
//			}				
	...
	public static ProcessActionResponse requestWorkmanager(ApplicationGroupDataM applicationGroup,String userId){
		...
		try{
			...
			workManagerRequestDataM.setWmFn(WM_ACTION_PRE_APPROVED);
