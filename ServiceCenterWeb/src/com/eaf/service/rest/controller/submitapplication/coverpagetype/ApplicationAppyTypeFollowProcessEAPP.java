...
public class ApplicationAppyTypeFollowProcessEAPP implements ApplicationAppyTypeProcess {
	
	private static Logger logger = Logger.getLogger(ApplicationAppyTypeFollowProcessEAPP.class);	
