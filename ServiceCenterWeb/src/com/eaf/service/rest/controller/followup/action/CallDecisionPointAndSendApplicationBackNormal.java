...
public class CallDecisionPointAndSendApplicationBackNormal extends SendApplicationBack implements FollowupAction {

	private static Logger logger = Logger.getLogger(CallDecisionPointAndSendApplicationBackNormal.class);
