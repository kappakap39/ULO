...
<link rel="stylesheet" href="css/kbankulo-login.css"/>
<link rel="shortcut icon" href="images/kbank2.ico">
<style>
[name='password']{
	...
	<form action="Logon" method="post" name="logonForm"  autocomplete="off" class="outerlogin">
		...
		<article class="wraplogin">
			...
			<article class="login">
				...
				<section class="wraptext_user"><input name="userName" type="text" class="textbox_login" placeholder="Username" value="<%=userName%>" autocomplete="off"/></section>
				<section class="textbox_password"><input name="password" type="password" class="textbox_login" placeholder="Password" value="<%=password%>" autocomplete="new-password"/></section>
