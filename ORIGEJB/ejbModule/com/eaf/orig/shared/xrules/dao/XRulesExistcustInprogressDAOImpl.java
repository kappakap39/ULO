 ...
 */
public class XRulesExistcustInprogressDAOImpl extends OrigObjectDAO implements
        XRulesExistcustInprogressDAO {
    private static Logger log = Logger
            .getLogger(XRulesExistcustInprogressDAOImpl.class);

    /**
     *  
     */
    public XRulesExistcustInprogressDAOImpl() {
        super();
    }
    ...
    private void createTableXRULES_EXISTCUST_INPROGRESS(
        ...
        try {
            ...
            /*sql.append("INSERT INTO XRULES_EXISTCUST_INPROGRESS ");
            ...
            sql.append(" ,UPDATE_BY ,INSTALLMENT ,COBORROWER_FLAG )");*/
            sql.append("INSERT INTO XRULES_EXISTCUST_INPROGRESS ");
    ...
    private void deleteTableXRULES_EXISTCUST_INPROGRESS(
        ...
        try {
            ...
            conn = getConnection();
            StringBuffer sql = new StringBuffer("");
            sql.append("DELETE XRULES_EXISTCUST_INPROGRESS ");
    ...
    private Vector selectTableXRULES_EXISTCUST_INPROGRESS(String personalID)
        ...
        try {
            ...
            sql.append(" FROM XRULES_EXISTCUST_INPROGRESS WHERE PERSONAL_ID=?");
            String dSql = String.valueOf(sql);
            log.debug("Sql=" + dSql);
            ps = conn.prepareStatement(dSql);
            rs = null;
    ...
    private double updateTableXRULES_EXISTCUST_INPROGRESS(
        ...
        try {
            ...
            conn = getConnection();
            StringBuffer sql = new StringBuffer("");
            sql.append("UPDATE XRULES_EXISTCUST_INPROGRESS ");
            ...
            ps.setString(9, prmXRulesExistcustInprogressDataM.getApplicationRecordId());
            ps.setString(10, prmXRulesExistcustInprogressDataM.getCmpCde());
            ps.setString(11, prmXRulesExistcustInprogressDataM.getIdNo());
            ps.setInt(12, prmXRulesExistcustInprogressDataM.getSeq());*/
            ps.setString(1, prmXRulesExistcustInprogressDataM.getApplicationNo());
            ps.setString(2, prmXRulesExistcustInprogressDataM.getCustomerType());
            ps.setDate(3, this.parseDate(prmXRulesExistcustInprogressDataM.getApplicationDate()));
            ps.setBigDecimal(4, prmXRulesExistcustInprogressDataM.getFinanceAmt());
            ...
            ps.setBigDecimal(7,prmXRulesExistcustInprogressDataM.getInstallment());
            ps.setString(8,prmXRulesExistcustInprogressDataM.getCoBorrowerFlag());
            ps.setString(9, prmXRulesExistcustInprogressDataM.getPersonalID());
            ps.setInt(10, prmXRulesExistcustInprogressDataM.getSeq());
    ...
    private void deleteSomeTableXRULES_EXISTCUST_INPROGRESS(
        ...
        try {
            ...
            prmXRulesDebtDbDataM = (XRulesExistcustDataM) vXRulesExistcustInprogressDataM
                    .get(0);
