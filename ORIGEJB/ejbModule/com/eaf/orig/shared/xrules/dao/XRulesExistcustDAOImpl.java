 ...
 */
public class XRulesExistcustDAOImpl extends OrigObjectDAO implements
        XRulesExistcustDAO {
    private static Logger log = Logger.getLogger(XRulesExistcustDAOImpl.class);

    /**
     *  
     */
    public XRulesExistcustDAOImpl() {
        super();
    ...
    private void createTableXRULES_EXISTCUST(
        ...
        try {
            ...
            sql.append("INSERT INTO XRULES_EXISTCUST ");
            ...
            sql.append("  ,UPDATE_BY,ORI_FINANCE_AMT  )");*/
    ...
    private void deleteTableXRULES_EXISTCUST(
        ...
        try {
            ...
            conn = getConnection();
            StringBuffer sql = new StringBuffer("");
            sql.append("DELETE XRULES_EXISTCUST ");
    ...
    private Vector selectTableXRULES_EXISTCUST(String personalID) throws XRulesExistcustException {
        ...
        try {
            ...
            conn = getConnection();
            StringBuffer sql = new StringBuffer("");
            /*sql.append("SELECT  CMPCDE,IDNO,SEQ,CONTRACT_NO,COLLECTION_STATUS ");
            ...
            sql.append(" FROM XRULES_EXISTCUST WHERE APPLICATION_RECORD_ID = ? AND CMPCDE=? AND IDNO =?");*/
            sql.append("SELECT  PERSONAL_ID,SEQ,CONTRACT_NO,COLLECTION_STATUS ");
            sql.append(" ,CONTRACT_STATUS,CUSTOMER_TYPE,BOOKING_DATE,NET_FINANCE_AMT,OVERDUE_PERIOD  ");
            sql.append(" ,PAID_PERIOD,UNPAID_PERIOD,INSTALLMENT,UPDATE_DATE,UPDATE_BY,ORI_FINANCE_AMT    ");
            sql.append(" FROM XRULES_EXISTCUST WHERE PERSONAL_ID=?");
            String dSql = String.valueOf(sql);
            log.debug("Sql=" + dSql);
            ps = conn.prepareStatement(dSql);
            rs = null;
            ...
            while (rs.next()) {
                ...
                /*prmXRulesExistcustDataM.setApplicationRecordId(applicationRecordId);
                prmXRulesExistcustDataM.setCmpCde(rs.getString(1));
                prmXRulesExistcustDataM.setIdNo(rs.getString(2));
                prmXRulesExistcustDataM.setSeq(rs.getInt(3));
                prmXRulesExistcustDataM.setContractNo(rs.getString(4));
                prmXRulesExistcustDataM.setCollectionStatus(rs.getString(5));
                prmXRulesExistcustDataM.setContractStatus(rs.getString(6));
                prmXRulesExistcustDataM.setCustomerType(rs.getString(7));
                prmXRulesExistcustDataM.setBookingDate(rs.getDate(8));
                prmXRulesExistcustDataM.setNetFinanceAmount(rs.getBigDecimal(9));
                prmXRulesExistcustDataM.setOverDuePeriod(rs.getInt(10));
                prmXRulesExistcustDataM.setPaidPeriod(rs.getInt(11));
                prmXRulesExistcustDataM.setUnPaidPeriod(rs.getInt(12));
                prmXRulesExistcustDataM.setInstallment(rs.getBigDecimal(13));
                prmXRulesExistcustDataM.setUpdateDate(rs.getTimestamp(14));
                prmXRulesExistcustDataM.setUpdateBy(rs.getString(15));
                prmXRulesExistcustDataM.setOriginalFinaceAmount(rs.getBigDecimal(16));*/
    ...
    private double updateTableXRULES_EXISTCUST(
        ...
        try {
            ...
            conn = getConnection();
            StringBuffer sql = new StringBuffer("");
            sql.append("UPDATE XRULES_EXISTCUST ");
            ...
            /*ps.setString(13, prmXRulesExistcustDataM.getApplicationRecordId());
            ps.setString(14, prmXRulesExistcustDataM.getCmpCde());
            ps.setString(15, prmXRulesExistcustDataM.getIdNo());
            ps.setInt(16, prmXRulesExistcustDataM.getSeq());*/
            ps.setString(13, prmXRulesExistcustDataM.getPersonalID());
            ps.setInt(14, prmXRulesExistcustDataM.getSeq());
    ...
    private void deleteSomeTableXRULES_EXISTCUST(Vector vXRulesExistcustDataM)
        ...
        try {
            ...
            for (int i = 1; i < vXRulesExistcustDataM.size()
                ...
                prmXRulesDebtDbDataM = (XRulesExistcustDataM) vXRulesExistcustDataM
                        .get(i);
                sql.append("," + prmXRulesDebtDbDataM.getSeq());
            }
            sql.append(" )");
