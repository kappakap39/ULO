...
public class UserProfileDAOImpl extends OrigObjectDAO implements UserProfileDAO {
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getRoleOfUser(String)
	 */
...
//				}catch(Exception e){}
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getUserProfile(String)
	 */
	public UserDetailM getUserProfile(String userName) throws UserProfileException {
		...
		try{
			...
			while(rs.next()){
				...
				userM.setDmWithdrawalAuth(rs.getString("DM_WITHDRAWAL_AUTH"));
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getSupplierUserProfile(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getManagersOfUser(String)
	 */
...
//				if(conn!=null)conn.commit();
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getUserNameInManagerName(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getListOfUserNameInManagerName(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#convertUserVector2String(Vector)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getZoneByUserName(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getRegionOfficerInZone(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getCostCenter(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#managerIsStoreOfficer(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getZoneDescription(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getResponceZone(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getListUsersByOrganizeAndRole(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getListUsersByRegionAndRole(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getUsersByOrganizeAndRole(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getUsersByRegionAndRole(String, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getRegionOfficerInRegion(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#isSelectAllRegion(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getRegionByOrganizeID(String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getUserDetailByUserDetailM(UserDetailM)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#checkUserRole(UserDetailM, String)
	 */
	...
	/**
	 * @see com.eaf.orig.profile.dao.DAO.UserProfileDAO#getFullName(String)
	 */
